...
class UnityWebRequest implements Runnable {
    ...
    private void runSafe() {
        b.AbstractC0027b abstractC0027b;
        ...
        try {
            ...
            if (openConnection instanceof HttpsURLConnection) {
                ...
                if (this.e) {
                    abstractC0027b = new b.AbstractC0027b() { // from class: com.unity3d.player.UnityWebRequest.2
                        @Override // com.unity3d.player.b.AbstractC0027b, javax.net.ssl.X509TrustManager
                ...
                SSLSocketFactory a = b.a(abstractC0027b);
                if (a != null) {
