...
public final class b extends SSLSocketFactory {
    ...
    /* loaded from: classes.dex */
    public static abstract class AbstractC0027b implements X509TrustManager {
    ...
    private b(AbstractC0027b[] abstractC0027bArr) {
        SSLContext sSLContext = SSLContext.getInstance(SSLSocketFactoryFactory.DEFAULT_PROTOCOL);
        sSLContext.init(null, abstractC0027bArr, null);
    ...
    public static SSLSocketFactory a(AbstractC0027b abstractC0027b) {
        try {
            return abstractC0027b == null ? b() : new b(new AbstractC0027b[]{abstractC0027b});
        } catch (Exception e2) {
