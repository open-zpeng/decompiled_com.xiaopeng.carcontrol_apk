...
public class b {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        C0022b c0022b = new C0022b(i3, new byte[(i2 * 3) / 4]);
        if (!c0022b.a(bArr, i, i2, true)) {
            throw new IllegalArgumentException("bad base-64");
        }
        if (c0022b.a == c0022b.b.length) {
            return c0022b.b;
        }
        byte[] bArr2 = new byte[c0022b.a];
        System.arraycopy(c0022b.b, 0, bArr2, 0, c0022b.a);
        return bArr2;
    }
