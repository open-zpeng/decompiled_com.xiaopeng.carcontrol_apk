...
public class HvacControlSpeechModel implements ISpeechModel {
    ...
    public void onQuery(String event, String data, String callback) {
        ...
        switch (event.hashCode()) {
            ...
            case 500790044:
                ...
                break;
            case 530276128:
                if (event.equals("ac.switch.status")) {
                    c = '\"';
                    break;
                }
                break;
        ...
        switch (c) {
            ...
            case '!':
                ...
                return;
            case '\"':
                reply(event, callback, Boolean.valueOf(getHvacPowerModeStatus()));
                return;
            case '#':
    ...
    protected boolean getHvacPowerModeStatus() {
        LogUtils.d(TAG, "getHvacPowerModeStatus", false);
        return this.mHvacViewModel.isHvacPowerModeOn();
    }
}
