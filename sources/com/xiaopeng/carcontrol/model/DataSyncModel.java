...
public class DataSyncModel implements OnSyncChangedListener {
    ...
    static final String KEY_LOCK_RESPONSE_NEW = "KEY_LOCK_RESPONSE_NEW";
    ...
    static final String KEY_UNLOCK_RESPONSE_NEW = "KEY_UNLOCK_RESPONSE_NEW";
    ...
    public void saveAllDataForSync() {
        ...
        if (carBaseConfig.isSupportLockUnLockRspSep()) {
            XId.getSyncApi().putKey(KEY_LOCK_RESPONSE_NEW, String.valueOf(getLockResponseNew()));
            XId.getSyncApi().putKey(KEY_UNLOCK_RESPONSE_NEW, String.valueOf(getUnLockResponseNew()));
        }
    ...
    protected void saveToSync(String key, String value) {
        ...
        switch (key.hashCode()) {
            ...
            case 436482578:
                ...
                break;
            case 608663453:
                if (key.equals(KEY_UNLOCK_RESPONSE_NEW)) {
                    c = '8';
                    break;
                }
                break;
            ...
            case 847038181:
                ...
                break;
            case 859872534:
                if (key.equals(KEY_LOCK_RESPONSE_NEW)) {
                    c = '=';
                    break;
                }
                break;
        ...
        switch (c) {
            ...
            case '7':
                ...
                return;
            case '8':
                XId.getSyncApi().putKey(KEY_UNLOCK_RESPONSE_NEW, value);
                return;
            case '9':
        ...
        XId.getSyncApi().putKey(KEY_LOCK_RESPONSE_NEW, value);
    }
    ...
    protected void fillSyncDataList(List<SyncData> list) {
        ...
        String key = XId.getSyncApi().getKey(KEY_LOCK_RESPONSE_NEW, "");
        if (!TextUtils.isEmpty(key)) {
            list.add(new SyncData(KEY_LOCK_RESPONSE_NEW, key));
        }
        String key2 = XId.getSyncApi().getKey(KEY_UNLOCK_RESPONSE_NEW, "");
        if (!TextUtils.isEmpty(key2)) {
            list.add(new SyncData(KEY_UNLOCK_RESPONSE_NEW, key2));
        }
    ...
    public void fillSyncData(SyncData data, CarControlSyncDataEvent syncDataFlag) {
        ...
        switch (str.hashCode()) {
            ...
            case 436482578:
                ...
                break;
            case 608663453:
                if (str.equals(KEY_UNLOCK_RESPONSE_NEW)) {
                    c = '9';
                    break;
                }
                break;
            ...
            case 847038181:
                ...
                break;
            case 859872534:
                if (str.equals(KEY_LOCK_RESPONSE_NEW)) {
                    c = '>';
                    break;
                }
                break;
        ...
        switch (c) {
            ...
            case '9':
                if (isGuest()) {
                    this.mSyncDataValue.setUnLockResponseNew(SharedPreferenceUtil.getUnLockResponseNew());
                } else {
                    int parseInt17 = Integer.parseInt(data.value);
                    this.mSyncDataValue.setUnLockResponseNew(parseInt17);
                    SharedPreferenceUtil.setUnLockResponseNew(parseInt17);
                }
                syncDataFlag.setUnLockResponseNew(true);
                return;
            case ':':
            ...
            case '<':
                if (isGuest()) {
                    ...
                    this.mSyncDataValue.setNraState(parseInt18);
                    SharedPreferenceUtil.setNraState(parseInt18);
                }
            ...
            case '>':
                if (isGuest()) {
                    this.mSyncDataValue.setLockResponseNew(SharedPreferenceUtil.getLockResponseNew());
                } else {
                    int parseInt19 = Integer.parseInt(data.value);
                    this.mSyncDataValue.setLockResponseNew(parseInt19);
                    SharedPreferenceUtil.setLockResponseNew(parseInt19);
                }
                syncDataFlag.setLockResponseNew(true);
                return;
            case '?':
                if (isGuest()) {
            ...
            case 'D':
                if (isGuest()) {
                    ...
                    this.mSyncDataValue.setDriveMode(parseInt20);
                    SharedPreferenceUtil.setDriveMode(parseInt20);
                }
            ...
            case 'M':
                if (isGuest()) {
                    ...
                    this.mSyncDataValue.setAvasEffect(parseInt21);
                    SharedPreferenceUtil.setAvasLowSpdEffect(parseInt21);
                }
                syncDataFlag.setAvasEffect(true);
                return;
            case 'N':
            ...
            case 'O':
                ...
                this.mSyncDataValue.setDrvSeatPosIdx(parseInt22);
                SharedPreferenceUtil.setDrvSeatMemoryIndex(parseInt22);
                return;
            case 'P':
                if (isGuest()) {
            ...
            case 'U':
                if (isGuest()) {
                    ...
                    this.mSyncDataValue.setRecycleGrade(parseInt23);
                    SharedPreferenceUtil.setEnergyRecycleGrade(parseInt23);
                }
            ...
            case '[':
                if (isGuest()) {
                    ...
                    int parseInt24 = Integer.parseInt(data.value);
                    this.mSyncDataValue.setSayHiEffect(parseInt24);
                    SharedPreferenceUtil.setAvasFriendEffect(parseInt24);
                }
            ...
            case '_':
                if (isGuest()) {
                    ...
                    int parseInt25 = Integer.parseInt(data.value);
                    this.mSyncDataValue.setUnlockResponse(parseInt25);
                    SharedPreferenceUtil.setUnlockResponse(parseInt25);
                }
    ...
    public void setLockResponseNew(int mode) {
        LogUtils.i(TAG, "setLockResponseNew: " + mode);
        this.mSyncDataValue.setLockResponseNew(mode);
        if (!isGuest()) {
            save(KEY_LOCK_RESPONSE_NEW, String.valueOf(mode));
        }
        SharedPreferenceUtil.setLockResponseNew(mode);
    }

    public int getLockResponseNew() {
        if (isGuest()) {
            return SharedPreferenceUtil.getLockResponseNew();
        }
        return this.mSyncDataValue.getLockResponseNew();
    }

    public void setUnLockResponseNew(int mode) {
        LogUtils.i(TAG, "setUnLockResponseNew: " + mode);
        this.mSyncDataValue.setUnLockResponseNew(mode);
        if (!isGuest()) {
            save(KEY_UNLOCK_RESPONSE_NEW, String.valueOf(mode));
        }
        SharedPreferenceUtil.setUnLockResponseNew(mode);
    }

    public int getUnLockResponseNew() {
        if (isGuest()) {
            return SharedPreferenceUtil.getUnLockResponseNew();
        }
        return this.mSyncDataValue.getUnLockResponseNew();
    }
    ...
    void generateAllDefaultSyncData() {
        ...
        if (carBaseConfig.isSupportLockUnLockRspSep()) {
            this.mSyncFullMap.put(KEY_LOCK_RESPONSE_NEW, new SyncData(KEY_LOCK_RESPONSE_NEW, String.valueOf(GlobalConstant.DEFAULT.LOCK_RESPONSE_NEW)));
            this.mSyncFullMap.put(KEY_UNLOCK_RESPONSE_NEW, new SyncData(KEY_UNLOCK_RESPONSE_NEW, String.valueOf(1)));
        }
