...
public class CarControlSyncDataValue {
    ...
    private int mLockResponseNew = GlobalConstant.DEFAULT.UNLOCK_RESPONSE;
    private int mUnLockResponseNew = GlobalConstant.DEFAULT.UNLOCK_RESPONSE;
    ...
    public void setLockResponseNew(int lockResponseNew) {
        this.mLockResponseNew = lockResponseNew;
    }
    ...
    public void setUnLockResponseNew(int unLockResponseNew) {
        this.mUnLockResponseNew = unLockResponseNew;
    }
