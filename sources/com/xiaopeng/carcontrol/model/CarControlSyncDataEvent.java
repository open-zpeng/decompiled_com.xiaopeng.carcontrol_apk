...
public class CarControlSyncDataEvent {
    ...
    private boolean lockResponseNew;
    private boolean lss;
    ...
    private boolean unlockResponseNew;
    ...
    public boolean isLockResponseNew() {
        return this.lockResponseNew;
    }

    public void setLockResponseNew(boolean lockResponseNew) {
        this.lockResponseNew = lockResponseNew;
    }

    public boolean isUnLockResponseNew() {
        return this.unlockResponseNew;
    }

    public void setUnLockResponseNew(boolean unlockResponseNew) {
        this.unlockResponseNew = unlockResponseNew;
    }
