...
public final class SharedPreferenceUtil {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getLockResponseNew() {
        return sSharedPref.getInt(GlobalConstant.PREFS.PREF_LOCK_RESPONSE_NEW_INT, GlobalConstant.DEFAULT.LOCK_RESPONSE_NEW);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setLockResponseNew(int response) {
        sSharedPref.edit().putInt(GlobalConstant.PREFS.PREF_LOCK_RESPONSE_NEW_INT, response).apply();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnLockResponseNew() {
        return sSharedPref.getInt(GlobalConstant.PREFS.PREF_UNLOCK_RESPONSE_NEW_INT, 1);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setUnLockResponseNew(int response) {
        sSharedPref.edit().putInt(GlobalConstant.PREFS.PREF_UNLOCK_RESPONSE_NEW_INT, response).apply();
    }
    ...
    public static void setFirstExitSpaceCapsuleMode(boolean isFirst) {
        sSharedPref.edit().putBoolean(GlobalConstant.PREFS.PREF_FIRST_EXIT_SPACE_CAPSULE_BOOL, isFirst).apply();
    }

    public static boolean isFirstExitSpaceCapsuleMode() {
        return sSharedPref.getBoolean(GlobalConstant.PREFS.PREF_FIRST_EXIT_SPACE_CAPSULE_BOOL, true);
    }

    public static void setEnterSpaceCapsuleFromButton(boolean fromButton) {
        sSharedPref.edit().putBoolean(GlobalConstant.PREFS.PREF_ENTER_SPACE_CAPSULE_FROM_BUTTON_BOOL, fromButton).apply();
    }

    public static boolean isEnterSpaceCapsuleFromButton() {
        return sSharedPref.getBoolean(GlobalConstant.PREFS.PREF_ENTER_SPACE_CAPSULE_FROM_BUTTON_BOOL, false);
    }
