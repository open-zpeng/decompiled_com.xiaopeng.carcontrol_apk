...
public class FunctionModel {
    ...
    private static final String SP_KEY_UNLOCK_RSP_TRANSFER_FLAG = "unlock_rsp_transfer_flag";
    ...
    public boolean getUnlockRspTransferSw() {
        return this.mSp.getBoolean(SP_KEY_UNLOCK_RSP_TRANSFER_FLAG, false);
    }

    public void setUnlockRspTransferSw(boolean on) {
        this.mSp.edit().putBoolean(SP_KEY_UNLOCK_RSP_TRANSFER_FLAG, on);
    }
}
