...
public class SeatMirrorCtrlMenu extends AbstractPopPanelMenu {
    ...
    private XImageView mCloseBtnBg;
    ...
    public void onInitView() {
        super.onInitView();
        this.mCloseBtnBg = (XImageView) findViewById(R.id.close_bg);
        ...
        this.mTimeTxt = (XTextView) findViewById(R.id.time);
        XTextView xTextView = (XTextView) findViewById(R.id.title);
        this.mTitle = xTextView;
    ...
    public void onShowTimeUpdate(long millisUntilFinished) {
        ...
        if (isShow()) {
            ...
            if (d < 0.0d || (xTextView = this.mTimeTxt) == null) {
                return;
            }
            xTextView.setText(((long) Math.floor(d)) + ResUtils.getString(R.string.seconds));
        }
    }
    ...
    public /* synthetic */ void lambda$new$4$SeatMirrorCtrlMenu(Float curSpeed) {
        if (!isShow() || curSpeed == null || getRootView() == null) {
            return;
        }
