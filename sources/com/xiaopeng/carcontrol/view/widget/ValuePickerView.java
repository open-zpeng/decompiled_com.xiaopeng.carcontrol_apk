...
public class ValuePickerView extends View {
    ...
    private static final int HANDLER_WHAT_VIEW_ENABLED = 4;
    ...
    private void initHandler() {
        ...
        this.mHandlerInNewThread = new Handler(this.mHandlerThread.getLooper()) { // from class: com.xiaopeng.carcontrol.view.widget.ValuePickerView.1
            ...
            public void handleMessage(Message msg) {
                ...
                if (ValuePickerView.this.mHandlerInMainThread != null) {
                    ValuePickerView.this.mHandlerInMainThread.sendMessageDelayed(ValuePickerView.this.getMsg(4), 0L);
                }
            }
        };
        this.mHandlerInMainThread = new Handler(Looper.getMainLooper()) { // from class: com.xiaopeng.carcontrol.view.widget.ValuePickerView.2
            ...
            public void handleMessage(Message msg) {
                ...
                if (i == 2) {
                    ...
                    ValuePickerView.this.setEnabled(true);
                }
            }
        };
    }
    ...
    private void respondPickedValueChangedInScrolling(int oldVal, int newVal) {
        LogUtils.d(TAG, hashCode() + " respondPickedValueChangedInScrolling drv oldVal:" + oldVal + " ,newVal:" + newVal);
    ...
    protected void onDetachedFromWindow() {
        ...
        if (handler2 != null) {
            ...
            this.mHandlerInMainThread.removeMessages(4);
        }
    ...
    public void smoothScrollToValue(int fromValue, int toValue, boolean needRespond) {
        int i;
        LogUtils.d(TAG, hashCode() + ":fromValue:" + fromValue + ",toValue:" + toValue + ",mWrapSelectorWheel:" + this.mWrapSelectorWheel + ",mWrapSelectorWheelCheck:" + this.mWrapSelectorWheelCheck);
        boolean z = false;
    ...
    private void scrollByIndexSmoothly(int deltaIndex, boolean needRespond) {
        ...
        if (handler != null) {
            handler.removeMessages(1);
            if (needRespond) {
                this.mHandlerInNewThread.sendMessageDelayed(getMsg(1), i2 / 4);
            } else {
                this.mHandlerInNewThread.sendMessageDelayed(getMsg(1, 0, 0, Boolean.valueOf(needRespond)), i2 / 4);
            }
        }
        postInvalidate();
    }
    ...
    public int getPickedIndexRelativeToRaw() {
        ...
        if (i != 0) {
            int i2 = this.mItemHeight;
            if (i < (-i2) / 2) {
                willPickIndexByGlobalY = getWillPickIndexByGlobalY(this.mCurrDrawGlobalY + i2 + i);
            } else {
                willPickIndexByGlobalY = getWillPickIndexByGlobalY(this.mCurrDrawGlobalY + i);
            }
        } else {
            willPickIndexByGlobalY = getWillPickIndexByGlobalY(this.mCurrDrawGlobalY);
        }
        LogUtils.d(TAG, hashCode() + ":getPickedIndexRelativeToRaw:" + willPickIndexByGlobalY);
    ...
    public void onScrollStateChange(int scrollState) {
        ...
        if (this.mOnScrollListener != null) {
            LogUtils.d(TAG, hashCode() + " onScrollStateChange: scrollState: " + scrollState);
    ...
    */
    ...
    private void clickItem(int showCountIndex) {
        int i;
        LogUtils.d(TAG, "clickItem showCountIndex:" + showCountIndex + ",value:" + getValue() + ",minValue:" + this.mMinValue + ",maxValue:" + this.mMaxValue);
    ...
    public void stopScrollingAndCorrectPosition() {
        ...
        Handler handler = this.mHandlerInNewThread;
        if (handler != null) {
            handler.sendMessageDelayed(getMsg(1, 0, 0, false), 0L);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Message getMsg(int what) {
