...
import com.xiaopeng.carcontrol.helper.ResHelper;
...
public class WindRenderer implements GLSurfaceView.Renderer {
    ...
    private int[] mResources = {R.drawable.hvac_wind_strip, ResHelper.getHvacBg(), R.drawable.bg_air_outlet, R.drawable.hvac_blow_window0, R.drawable.hvac_blow_feet};
    ...
    public void onThemeChanged(HvacWindTempMode windTempMode) {
        ...
        if (iArr != null) {
            ...
            TextureHelper.changeTexture(this.context, this.mTextures[1], ResHelper.getHvacBg());
