...
import com.xiaopeng.carcontrol.view.fragment.spacecapsule.SeatLayFlatFragment;
...
public class SpaceCapsuleUseGuideActivity extends XActivity implements ICapsuleSleepGuideInterface {
    ...
    private final String SEAT_LAY_FLAT_PAGE_TAG = "seat_lay_flat";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mEnter) {
            if (BaseFeatureOption.getInstance().isSupportAutoSeat()) {
                replaceFragment("shade_setup");
            } else {
                replaceFragment("seat_lay_flat");
            }
        } else {
    ...
    private void replaceFragment(String fragmentTag) {
        ...
        if (findFragmentByTag2 == null) {
            if ("seat_lay_flat".equals(fragmentTag)) {
                newInstance = SeatLayFlatFragment.newInstance();
            } else if ("shade_setup".equals(fragmentTag)) {
