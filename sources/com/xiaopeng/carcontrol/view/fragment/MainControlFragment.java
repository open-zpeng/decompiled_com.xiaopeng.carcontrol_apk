...
public class MainControlFragment extends BaseFragment {
    ...
    private void initMainControlLayout() {
        ...
        initPositionLamp(this.mPreloadLayout);
    ...
    public void updateDriveMode(DriveMode driveMode) {
        ...
        if (this.mDriveModeTabItem == null || this.mDriveModeTab == null) {
            ...
            int i = AnonymousClass10.$SwitchMap$com$xiaopeng$carcontrol$viewmodel$vcu$DriveMode[driveMode.ordinal()];
            if (i == 1) {
    ...
    public void updateHeadLamp(LampMode state) {
        if (state != null) {
            int i = AnonymousClass10.$SwitchMap$com$xiaopeng$carcontrol$viewmodel$lamp$LampMode[state.ordinal()];
            int i2 = 3;
            if (i == 1) {
                i2 = 0;
            } else if (i == 2) {
    ...
    public void updateWindows(WindowState state) {
        ...
        if (BaseFeatureOption.getInstance().isSupportAllWindowState()) {
            switch (AnonymousClass10.$SwitchMap$com$xiaopeng$carcontrol$viewmodel$cabin$WindowState[state.ordinal()]) {
                case 1:
        ...
        int i = AnonymousClass10.$SwitchMap$com$xiaopeng$carcontrol$viewmodel$cabin$WindowState[state.ordinal()];
        if (i == 3) {
            showWinBtnLoading(this.mOpenWinBtn, this.mCloseWinBtn, this.mVentBtn);
        } else if (i == 4) {
            showWinBtnLoading(this.mCloseWinBtn, this.mOpenWinBtn, this.mVentBtn);
    ...
    private void controlTrunk(View trunkBtn) {
        ...
        } else if (trunkBtn == this.mOpenTrunkBtn && this.mVcuVm.getGearLevelValue() != GearLevel.P) {
    ...
    private void updateTrunkBtn(TrunkState state, boolean isMock) {
        ...
        switch (AnonymousClass10.$SwitchMap$com$xiaopeng$carcontrol$viewmodel$cabin$TrunkState[state.ordinal()]) {
            case 1:
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.xiaopeng.carcontrol.view.fragment.MainControlFragment$10  reason: invalid class name */
    /* loaded from: classes2.dex */
    ...
    private void initPositionLamp(View parent) {
        if (CarBaseConfig.getInstance().isSupportSaberLightMode() && !CarBaseConfig.getInstance().isSupportLlu()) {
            View findViewById = parent.findViewById(R.id.position_lamp_mode_item);
            findViewById.setVisibility(0);
            XTabLayout xTabLayout = (XTabLayout) findViewById.findViewById(R.id.position_lamp_mode_tab);
            this.mPositionLampTab = xTabLayout;
            ViewGroup.LayoutParams layoutParams = xTabLayout.getLayoutParams();
            layoutParams.width = ResUtils.getDimensionPixelSize(R.dimen.main_page_position_lamp_tab_width);
            this.mPositionLampTab.setLayoutParams(layoutParams);
            updateXTabLayout(this.mPositionLampTab, !this.mLampVm.isParkLampIncludeFmB());
            this.mPositionLampTab.setOnTabChangeListener(new XTabLayout.OnTabChangeListenerAdapter() { // from class: com.xiaopeng.carcontrol.view.fragment.MainControlFragment.9
                @Override // com.xiaopeng.xui.widget.XTabLayout.OnTabChangeListenerAdapter, com.xiaopeng.xui.widget.XTabLayout.OnTabChangeListener
                public boolean onInterceptTabChange(XTabLayout tabLayout, int index, boolean tabChange, boolean fromUser) {
                ...
                public void onTabChangeEnd(XTabLayout tabLayout, int index, boolean tabChange, boolean fromUser) {
                    if (fromUser) {
                        MainControlFragment.this.mLampVm.setParkLampIncludeFmB(index == 0);
                        StatisticUtils.sendStatistic(PageEnum.LAMP_PAGE, BtnEnum.LAMP_PAGE_SIDE_LIGHT_MODE_BTN, Integer.valueOf(index + 1));
                    }
                }
            });
            setLiveDataObserver(this.mLampVm.getParkLightRelatedFMBLightState(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.-$$Lambda$MainControlFragment$kBFPMAlaMcXdbdsgxWXqtJumcAo
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    MainControlFragment.this.lambda$initPositionLamp$13$MainControlFragment((Boolean) obj);
                }
            });
        }
    }

    public /* synthetic */ void lambda$initPositionLamp$13$MainControlFragment(Boolean enabled) {
        if (enabled != null) {
