...
public class MattressSetupFragment extends SpaceBaseFragment {
    ...
    private void init(View view) {
        ...
        final BaseFeatureOption baseFeatureOption = BaseFeatureOption.getInstance();
        if (string.equals("guideBtn") || !baseFeatureOption.isSupportSpaceCapsuleGuideSetting()) {
        ...
        view.findViewById(R.id.capsule_sleep_guide_mattress_pre_btn).setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.spacecapsule.-$$Lambda$MattressSetupFragment$dPv4xJq-qx0-pawZ9P7U2W-Dc3g
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                MattressSetupFragment.this.lambda$init$1$MattressSetupFragment(baseFeatureOption, view2);
            }
        });
    ...
    public /* synthetic */ void lambda$init$1$MattressSetupFragment(final BaseFeatureOption featureOption, View v) {
        if (this.mSleepGuideListener != null) {
            if (featureOption.isSupportAutoSeat()) {
                this.mSleepGuideListener.onShadeSetup();
            } else {
                this.mSleepGuideListener.onSeatLayFlat();
            }
        }
    }
