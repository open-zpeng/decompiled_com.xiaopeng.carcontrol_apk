...
public class MattressStoreFragment extends SpaceBaseFragment {
    ...
    private void init(View view) {
        ...
        boolean equals = "guideBtn".equals(string);
        boolean isSupportSpaceCapsuleGuideSetting = BaseFeatureOption.getInstance().isSupportSpaceCapsuleGuideSetting();
        if (equals || !isSupportSpaceCapsuleGuideSetting) {
            xCheckBox.setVisibility(8);
        } else {
            xCheckBox.setVisibility(0);
        }
        if (!isSupportSpaceCapsuleGuideSetting && !equals) {
            view.findViewById(R.id.capsule_sleep_guide_tip).setVisibility(0);
        }
        if (this.mEnter) {
    ...
    public /* synthetic */ void lambda$init$3$MattressStoreFragment(View v) {
        ...
        SharedPreferenceUtil.setEnterSpaceCapsuleFromButton(true);
    }
