...
public class SettingsFragment extends BaseFragment {
    ...
    */
    private boolean checkIfXpuAvailable(android.view.View r5, boolean r6) {
        /*
            ...
            return r2
        L13:
            int[] r3 = com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.AnonymousClass14.$SwitchMap$com$xiaopeng$carcontrol$viewmodel$xpu$NedcState
            int r0 = r0.ordinal()
            r0 = r3[r0]
            if (r0 == r2) goto L2a
            r3 = 2
    ...
    private void initDsmSwLayout(ViewGroup parent) {
        ...
        if (CarBaseConfig.getInstance().isSupportDsmCamera()) {
            ...
            if (CarBaseConfig.getInstance().isSupportSrrMiss()) {
                ...
                initDsmCameraSt(this.mScuViewModel.getDsmState(), this.mXpuVm.getNedcState());
                setLiveDataObserver(this.mScuViewModel.getDsmStateData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$42QfeJYbb0P3jwXvD9U0T7zPZXE
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.this.lambda$initDsmSwLayout$16$SettingsFragment((DsmState) obj);
                    }
                });
                setLiveDataObserver(this.mXpuVm.getNedcStateData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$7ZulVW-UxIxvZVV1gBTSinS91So
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.this.lambda$initDsmSwLayout$17$SettingsFragment((NedcState) obj);
                    }
                });
            }
        }
        if (CarBaseConfig.getInstance().isSupportRemoteCamera()) {
            ...
            xSwitch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$aQxnvcDvPyT-fHsRtI8oOrRQcs8
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initDsmSwLayout$18$SettingsFragment(compoundButton, z);
                }
            });
    ...
    public /* synthetic */ boolean lambda$initDsmSwLayout$15$SettingsFragment(View v, MotionEvent event) {
        ...
        if (ClickHelper.isFastClick(500L, false)) {
        ...
        } else if (this.mScuViewModel.getDsmState() == DsmState.TurnOning) {
            ...
            if (this.mXpuVm.getNedcState() == NedcState.On) {
                NotificationHelper.getInstance().showToast(R.string.dsm_nedc_open_toast);
                vuiFeedbackClick(R.string.dsm_nedc_open_toast, this.mDsmSw);
                return true;
            } else if (this.mScuViewModel.getDsmState() == DsmState.Failure) {
            ...
            showDialog(BaseFeatureOption.getInstance().isSupportDsmRegulation() ? R.string.fatigue_reminder_title_tv : R.string.ciu_inner_camera_title_tv, BaseFeatureOption.getInstance().isSupportDsmRegulation() ? R.string.fatigue_reminder_confirm : R.string.ciu_inner_camera_feature_feedback_new, getStringById(R.string.btn_cancel), (XDialogInterface.OnClickListener) null, getStringById(R.string.btn_ok), new XDialogInterface.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$gXXE2oc7g-JL8NHwF1oqpPy0DjY
                ...
                public final void onClick(XDialog xDialog, int i) {
                    SettingsFragment.this.lambda$null$14$SettingsFragment(xDialog, i);
                }
    ...
    public /* synthetic */ void lambda$initDsmSwLayout$16$SettingsFragment(DsmState dsmState) {
        XSwitch xSwitch = this.mDsmSw;
        if (xSwitch == null || dsmState == null) {
            return;
        }
    ...
    public /* synthetic */ void lambda$initDsmSwLayout$17$SettingsFragment(NedcState nedcState) {
        if (this.mDsmSw == null || nedcState == null) {
            return;
        }
        boolean z = false;
        if (nedcState == NedcState.On) {
            this.mDsmSw.setChecked(false);
            return;
        }
        DsmState dsmState = this.mScuViewModel.getDsmState();
        this.mDsmSw.setChecked((dsmState == DsmState.On || dsmState == DsmState.TurnOning) ? true : true);
    }

    public /* synthetic */ void lambda$initDsmSwLayout$18$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed()) {
            this.mScuViewModel.setRemoteCameraSw(isChecked);
        }
    }

    private void initDsmCameraSt(DsmState dsmState, NedcState nedcState) {
        XSwitch xSwitch;
        if (dsmState == null || (xSwitch = this.mDsmSw) == null || nedcState == null) {
            return;
        }
        xSwitch.setChecked(nedcState != NedcState.On && (dsmState == DsmState.On || dsmState == DsmState.TurnOning));
    }
    ...
    private void initTrunk(View parent) {
        if (CarBaseConfig.getInstance().isSupportSensorTrunk() || CarBaseConfig.getInstance().isSupportTrunkSetPosition()) {
            ...
            if (CarBaseConfig.getInstance().isSupportSensorTrunk()) {
                ...
                xSwitch.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$P5QUnSFk9VdoC3gav5cAx6mDDVI
                    @Override // android.view.View.OnTouchListener
                    public final boolean onTouch(View view, MotionEvent motionEvent) {
                        return SettingsFragment.lambda$initTrunk$19(view, motionEvent);
                    }
                });
                xSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$ZuxK9BsdLHAedoUPDTaWjFcwA-Y
                    @Override // android.widget.CompoundButton.OnCheckedChangeListener
                    public final void onCheckedChanged(CompoundButton compoundButton, boolean z2) {
                        SettingsFragment.this.lambda$initTrunk$20$SettingsFragment(compoundButton, z2);
                    }
                });
            ...
            if (CarBaseConfig.getInstance().isSupportTrunkSetPosition()) {
                ...
                setLiveDataObserver(this.mWindowDoorViewModel.getTrunkFullOpenPosData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$GkU6cqZH4iVWy-rfkrJkFu_4kF8
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        XSlider.this.setCurrentIndex(((Integer) obj).intValue() / 10);
                    }
                });
                setLiveDataObserver(this.mWindowDoorViewModel.getRearTrunkData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$gdHoR_l1qr817hO2RlaOw4C0Ex0
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
    ...
    public static /* synthetic */ boolean lambda$initTrunk$19(View v, MotionEvent event) {
        return event.getAction() == 0 && ClickHelper.isFastClick(v.getId(), 1000L, false);
    }

    public /* synthetic */ void lambda$initTrunk$20$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
    ...
    private void initMichophoneSwLayout(ViewGroup parent) {
        ...
        this.mMicrophoneSw.setOnInterceptListener(new XSwitch.OnInterceptListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$GDl_GUtV6INl0-nhnfOc9lS6oyw
            @Override // com.xiaopeng.xui.widget.XSwitch.OnInterceptListener
            public final boolean onInterceptCheck(View view, boolean z) {
                return SettingsFragment.this.lambda$initMichophoneSwLayout$23$SettingsFragment(view, z);
            }
        });
    ...
    public /* synthetic */ boolean lambda$initMichophoneSwLayout$23$SettingsFragment(View view, boolean isChecked) {
        if (view.isPressed() || isVuiAction(view)) {
            if (ClickHelper.isFastClick(500L, false)) {
                LogUtils.i(this.TAG, "Click too fast", false);
                return true;
    ...
    public void onPageDirectShow(String name) {
        if (sElementDirectSupport[0].equals(name)) {
            ...
            if (xListSingle != null) {
                XViewLocationUtils.scrollByLocation(xListSingle, new XViewLocationUtils.OnCorrectionLocationListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$UwAdlhcC8FJK8TOYU58K2Xj_WkM
                    ...
                    public final void onCorrectionLocationEnd(View view) {
                        SettingsFragment.this.lambda$onPageDirectShow$24$SettingsFragment(view);
                    }
                });
            } else {
                showIhbHelpInfo();
    ...
    public /* synthetic */ void lambda$onPageDirectShow$24$SettingsFragment(View view) {
        showIhbHelpInfo();
    }

    private void initLock(View container) {
        XListMultiple xListMultiple = (XListMultiple) container.findViewById(R.id.unlock_response_item);
        final XTabLayout xTabLayout = (XTabLayout) xListMultiple.findViewById(R.id.unlock_response_tab);
        if (!CarBaseConfig.getInstance().isNewAvasArch()) {
            xTabLayout.removeTab(2);
        }
        if (!CarBaseConfig.getInstance().isSupportLockUnLockRspSep()) {
            xListMultiple.setText(ResUtils.getString(R.string.unlock_response_title));
            xTabLayout.setVuiLabel(ResUtils.getString(R.string.unlock_response_title));
            container.findViewById(R.id.lock_response_item).setVisibility(8);
            ...
            setLiveDataObserver(this.mCarBodyViewModel.getUnlockResponseData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$q5KTCrMUyR87YUZMrSw7NWiqOGE
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
            ...
            container.findViewById(R.id.lock_response_item).setVisibility(0);
            xListMultiple.setText(ResUtils.getString(R.string.unlock_response_new_title));
            xTabLayout.setVuiLabel(ResUtils.getString(R.string.unlock_response_new_title));
            xTabLayout.setOnTabChangeListener(new XTabLayout.OnTabChangeListenerAdapter() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.4
                {
                    SettingsFragment.this = this;
                }
                ...
                public void onTabChangeEnd(XTabLayout xTabLayout2, int index, boolean tabChange, boolean fromUser) {
                    if (fromUser) {
                        if (index == 0) {
                            SettingsFragment.this.mCarBodyViewModel.setUnLockResponseNewMode(UnlockResponse.Light);
                        } else if (index == 1) {
                            SettingsFragment.this.mCarBodyViewModel.setUnLockResponseNewMode(UnlockResponse.LightAndHorn);
                        } else if (index == 2) {
                            SettingsFragment.this.mCarBodyViewModel.setUnLockResponseNewMode(UnlockResponse.LightAndAvas);
                        }
                        SettingsFragment.this.updateCarImgView(1);
                    }
                }
            });
            UnlockResponse unLockResponseNewMode = this.mCarBodyViewModel.getUnLockResponseNewMode();
            if (unLockResponseNewMode != null) {
                updateXTabLayout(xTabLayout, unLockResponseNewMode.ordinal());
            }
            setLiveDataObserver(this.mCarBodyViewModel.getUnLockResponseNewData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$x7GP8insNN97EXFbPVmFvLdxOOo
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.lambda$initLock$26(XTabLayout.this, (UnlockResponse) obj);
                }
            });
            final XTabLayout xTabLayout2 = (XTabLayout) container.findViewById(R.id.lock_response_item).findViewById(R.id.unlock_response_tab);
            xTabLayout2.setOnTabChangeListener(new XTabLayout.OnTabChangeListenerAdapter() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.5
                {
                    SettingsFragment.this = this;
                }
                ...
                public void onTabChangeEnd(XTabLayout xTabLayout3, int index, boolean tabChange, boolean fromUser) {
                    if (fromUser) {
                        if (index == 0) {
                            SettingsFragment.this.mCarBodyViewModel.setLockResponseNewMode(UnlockResponse.Light);
                        } else if (index == 1) {
                            SettingsFragment.this.mCarBodyViewModel.setLockResponseNewMode(UnlockResponse.LightAndHorn);
                        } else if (index == 2) {
                            SettingsFragment.this.mCarBodyViewModel.setLockResponseNewMode(UnlockResponse.LightAndAvas);
                        }
                        SettingsFragment.this.updateCarImgView(1);
                    }
                }
            });
            UnlockResponse lockResponseNewMode = this.mCarBodyViewModel.getLockResponseNewMode();
            if (lockResponseNewMode != null) {
                updateXTabLayout(xTabLayout2, lockResponseNewMode.ordinal());
            }
            setLiveDataObserver(this.mCarBodyViewModel.getLockResponseNewData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$gA6g6pW7xYJYc3G4hpUhebU1dlc
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.lambda$initLock$27(XTabLayout.this, (UnlockResponse) obj);
                }
            });
        }
        ...
        if (CarBaseConfig.getInstance().isSupportDhc()) {
            ...
            xSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$be5YDGLzm2mQ-wRW7GpzCQBODE0
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        ...
        xSwitch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$Qla10OIuTNVb4-jxTym5Vr01Le8
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                SettingsFragment.this.lambda$initLock$29$SettingsFragment(compoundButton, z);
            }
        });
        ...
        if (xListTwo2 != null) {
            if (CarBaseConfig.getInstance().isSupportNfc()) {
                ...
                this.mNfcKeySw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$1-j8YMnsWSps-o3bLnGE12gDoJs
                    @Override // android.widget.CompoundButton.OnCheckedChangeListener
                    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                        SettingsFragment.this.lambda$initLock$30$SettingsFragment(compoundButton, z);
                    }
                });
                this.mNfcKeySw.setOnInterceptListener(new XSwitch.OnInterceptListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$ygsmj8-bbsmt4wYxFX03J9eIYPQ
                    @Override // com.xiaopeng.xui.widget.XSwitch.OnInterceptListener
                    public final boolean onInterceptCheck(View view, boolean z) {
                        return SettingsFragment.this.lambda$initLock$31$SettingsFragment(view, z);
                    }
                });
        ...
        if (BaseFeatureOption.getInstance().isSupportDriveAutoLock()) {
            ...
            xSwitch5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$F49NlPBeGu1jDsKSeOXiHnl4A5o
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initLock$32$SettingsFragment(compoundButton, z);
                }
            });
        ...
        if (CarBaseConfig.getInstance().isSupportSdc()) {
            ...
            final XTabLayout xTabLayout3 = (XTabLayout) container.findViewById(R.id.double_click_open_tab);
            xTabLayout3.setOnTabChangeListener(new XTabLayout.OnTabChangeListenerAdapter() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.6
                {
                    SettingsFragment.this = this;
                }
            ...
            updateXTabLayout(xTabLayout3, this.mWindowDoorViewModel.getSdcKeyCfg() == 1 ? 0 : 1);
            setLiveDataObserver(this.mWindowDoorViewModel.getSdcKeyCfgData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$1qtPdTtJtmhYh2Y-J0CzPJW62Cc
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
            ...
            findViewById.setVisibility(0);
            final XTabLayout xTabLayout4 = (XTabLayout) findViewById.findViewById(R.id.sdc_brake_close_door_tab);
            xTabLayout4.setOnTabChangeListener(new XTabLayout.OnTabChangeListenerAdapter() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.7
                {
                    SettingsFragment.this = this;
                }
                ...
                @Override // com.xiaopeng.xui.widget.XTabLayout.OnTabChangeListener
                public void onTabChangeEnd(XTabLayout xTabLayout5, int index, boolean tabChange, boolean fromUser) {
                    if (fromUser && index == 0) {
            ...
            updateXTabLayout(xTabLayout4, this.mWindowDoorViewModel.getSdcBrakeCloseDoorCfg());
            setLiveDataObserver(this.mWindowDoorViewModel.getSdcBrakeCloseDoorCfgData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$8YRPgZbAf461SpZ-emYfEuObIsM
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.lambda$initLock$34(XTabLayout.this, (Integer) obj);
                }
            });
            ...
            xSlider.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$SmrQvcawGgryxcX7MWtAUqGkLzo
                @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
                public final void onGlobalLayout() {
                    SettingsFragment.this.lambda$initLock$35$SettingsFragment();
                }
            });
            this.mDoorAngleSlider.setStartIndex(8);
            this.mDoorAngleSlider.setEndIndex(20);
            this.mDoorAngleSlider.setSliderProgressListener(new XSlider.SliderProgressListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.8
                @Override // com.xiaopeng.xui.widget.slider.XSlider.SliderProgressListener
                public void onProgressChanged(XSlider xSlider2, float progress, String unit) {
                }
            ...
            this.mDoorAngleSlider.setProgressChangeListener(new XSlider.ProgressChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$cSQtbXmBf6n1sdg0CcPdoEmD868
                ...
                public final void onProgressChanged(XSlider xSlider2, float f, String str, boolean z) {
                    SettingsFragment.this.lambda$initLock$36$SettingsFragment(xSlider2, f, str, z);
                }
            });
            ...
            setLiveDataObserver(this.mWindowDoorViewModel.getLeftSdcSysRunningStateData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$pHv2WKWMb3cpqwsadCz9Bhnwqao
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initLock$37$SettingsFragment((Integer) obj);
                }
            });
            setLiveDataObserver(this.mWindowDoorViewModel.getRightSdcSysRunningStateData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$QncZHjueY-OtD8oo4oK7QlQuCiw
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initLock$38$SettingsFragment((Integer) obj);
                }
            });
            updateDoorAngle(Integer.valueOf(this.mWindowDoorViewModel.getSdcMaxAutoDoorOpeningAngle()));
        ...
        if (CarBaseConfig.getInstance().isSupportInductionLock()) {
            ...
            this.mInductionLockSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$5IGICkLgE7kk_LE_ErhEprExlxA
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initLock$39$SettingsFragment(compoundButton, z);
                }
            });
            this.mInductionLockSwitch.setOnInterceptListener(new XSwitch.OnInterceptListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$uxpSfyMrHBR9LDjBO2HS8YJJyHo
                @Override // com.xiaopeng.xui.widget.XSwitch.OnInterceptListener
                public final boolean onInterceptCheck(View view, boolean z) {
                    return SettingsFragment.this.lambda$initLock$40$SettingsFragment(view, z);
                }
            });
        ...
        if (CarBaseConfig.getInstance().isSupportPollingLock()) {
            ...
            xSwitch8.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$DIxV2z-j3jAz9UngraO-IU2k9eQ
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initLock$41$SettingsFragment(compoundButton, z);
                }
            });
            ...
            xSwitch9.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$RavaROP5ojRoNTTOuGW9Z7Sx2mU
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initLock$42$SettingsFragment(compoundButton, z);
                }
            });
    ...
    public static /* synthetic */ void lambda$initLock$26(final XTabLayout tabUnlockResponse, UnlockResponse unlockResponse) {
        if (unlockResponse != null) {
            updateXTabLayout(tabUnlockResponse, unlockResponse.ordinal());
        }
    }

    public static /* synthetic */ void lambda$initLock$27(final XTabLayout tabLockResponse, UnlockResponse lockResponse) {
        if (lockResponse != null) {
            updateXTabLayout(tabLockResponse, lockResponse.ordinal());
        }
    }
    ...
    public /* synthetic */ void lambda$initLock$29$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ void lambda$initLock$30$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed()) {
            this.mCarBodyViewModel.setStopNfcCardSw(isChecked);
        }
    }

    public /* synthetic */ boolean lambda$initLock$31$SettingsFragment(View buttonView, boolean isChecked) {
    ...
    public /* synthetic */ void lambda$initLock$32$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public static /* synthetic */ void lambda$initLock$34(final XTabLayout tabSdcBrakeCloseDoorCfg, Integer cfg) {
        if (cfg != null) {
            updateXTabLayout(tabSdcBrakeCloseDoorCfg, cfg.intValue());
        }
    }

    public /* synthetic */ void lambda$initLock$35$SettingsFragment() {
    ...
    public /* synthetic */ void lambda$initLock$36$SettingsFragment(XSlider xSlider, float v, String s, boolean b) {
        onSdcAngleSliderChange();
    }

    public /* synthetic */ void lambda$initLock$37$SettingsFragment(Integer state) {
        setAngleSliderEnable(true, state.intValue());
    }

    public /* synthetic */ void lambda$initLock$38$SettingsFragment(Integer state) {
        setAngleSliderEnable(false, state.intValue());
    }

    public /* synthetic */ void lambda$initLock$39$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        this.mCarBodyViewModel.setInductionLock(isChecked);
    }

    public /* synthetic */ boolean lambda$initLock$40$SettingsFragment(View buttonView, boolean checked) {
        if (checked) {
            if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ void lambda$initLock$41$SettingsFragment(CompoundButton buttonView, boolean checked) {
        this.mCarBodyViewModel.setNearUnlock(checked);
    }

    public /* synthetic */ void lambda$initLock$42$SettingsFragment(CompoundButton buttonView, boolean checked) {
    ...
    public void showSdcBrakeCloseDoorSafeDialog(final int index) {
        ...
        xDialog.setPositiveButton(getStringById(R.string.btn_confirm), new XDialogInterface.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$d5bZubvsS2TkItBMlw27ekTRF2Y
            @Override // com.xiaopeng.xui.app.XDialogInterface.OnClickListener
            public final void onClick(XDialog xDialog2, int i) {
                SettingsFragment.this.lambda$showSdcBrakeCloseDoorSafeDialog$43$SettingsFragment(index, xDialog2, i);
            }
        });
    ...
    public /* synthetic */ void lambda$showSdcBrakeCloseDoorSafeDialog$43$SettingsFragment(final int index, XDialog xDialog, int i) {
    ...
    private void showInductionLockDialog() {
        ...
        if (this.mInductionLockDialog == null) {
            ...
            this.mInductionLockDialog.setPositiveButton(getStringById(R.string.confirm_open), new XDialogInterface.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$o72XiYm7KktHOYU7dDXP_PBk1As
                @Override // com.xiaopeng.xui.app.XDialogInterface.OnClickListener
                public final void onClick(XDialog xDialog2, int i) {
                    SettingsFragment.this.lambda$showInductionLockDialog$44$SettingsFragment(xDialog2, i);
                }
            });
    ...
    public /* synthetic */ void lambda$showInductionLockDialog$44$SettingsFragment(XDialog xDialog, int i) {
    ...
    private void showNfcKeyConfirmDialog() {
        ...
        if (this.mNfcKeyConfirmDialog == null) {
            ...
            this.mNfcKeyConfirmDialog.setPositiveButton(getStringById(R.string.btn_confirm), new XDialogInterface.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$d4-gBIMsNfv8dI6sEfnrJxXz2Dg
                @Override // com.xiaopeng.xui.app.XDialogInterface.OnClickListener
                public final void onClick(XDialog xDialog2, int i) {
                    SettingsFragment.this.lambda$showNfcKeyConfirmDialog$45$SettingsFragment(xDialog2, i);
                }
            });
    ...
    public /* synthetic */ void lambda$showNfcKeyConfirmDialog$45$SettingsFragment(XDialog xDialog, int i) {
    ...
    private void showPsnSrsCloseConfirmDialog() {
        ...
        if (this.mPsnSrsConfirmDialog == null) {
            ...
            this.mPsnSrsConfirmDialog.setPositiveButton(getStringById(R.string.btn_confirm), new XDialogInterface.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$iOBDaML-4UvfEixxLKlRPn06bIA
                @Override // com.xiaopeng.xui.app.XDialogInterface.OnClickListener
                public final void onClick(XDialog xDialog2, int i) {
                    SettingsFragment.this.lambda$showPsnSrsCloseConfirmDialog$46$SettingsFragment(xDialog2, i);
                }
            });
    ...
    public /* synthetic */ void lambda$showPsnSrsCloseConfirmDialog$46$SettingsFragment(XDialog xDialog, int i) {
    ...
    private void initWindow(View container) {
        ...
        if (CarBaseConfig.getInstance().isSupportAutoCloseWin()) {
            ...
            xSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$QhsWEi6qHMk-RZ-VmBRJz7IS8M4
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initWindow$47$SettingsFragment(compoundButton, z);
                }
            });
            xSwitch.setChecked(this.mWindowDoorViewModel.getAutoWindowLockSw());
            setLiveDataObserver(this.mWindowDoorViewModel.getAutoWindowLockSwData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$Pj1XffR02tY4gbRMZWDaEIxQJV4
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.lambda$initWindow$48(XSwitch.this, (Boolean) obj);
                }
            });
        } else {
        ...
        xSwitch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$zNV4U57wZ4Ep0tYaoo-o6IgifQM
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                SettingsFragment.this.lambda$initWindow$49$SettingsFragment(compoundButton, z);
            }
        });
        xSwitch2.setChecked(this.mWindowDoorViewModel.isHighSpdCloseWinEnabled());
        setLiveDataObserver(this.mWindowDoorViewModel.getHighSpdCloseWinSwData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$N1lWGd70SquFpFRJlg8TcN322fU
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                SettingsFragment.lambda$initWindow$50(XSwitch.this, (Boolean) obj);
            }
        });
        if (CarBaseConfig.getInstance().isSupportSdc()) {
            ...
            xSwitch3.setOnInterceptListener(new XSwitch.OnInterceptListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$Kxa6NGAF4_SfNPHS6ltjzh8QYbk
                @Override // com.xiaopeng.xui.widget.XSwitch.OnInterceptListener
                public final boolean onInterceptCheck(View view, boolean z) {
                    return SettingsFragment.lambda$initWindow$51(view, z);
                }
            });
            xSwitch3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$hkhy4oi91PnMZY_6C0S5HKUfn0w
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initWindow$52$SettingsFragment(compoundButton, z);
                }
            });
            xSwitch3.setChecked(this.mWindowDoorViewModel.getSdcWinAutoDown());
            setLiveDataObserver(this.mWindowDoorViewModel.getSdcWinAutoDownData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$L84VS27U_KcKyX5hQakE6buVpik
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.lambda$initWindow$53(XSwitch.this, (Boolean) obj);
                }
            });
        }
    }

    public /* synthetic */ void lambda$initWindow$47$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public static /* synthetic */ void lambda$initWindow$48(final XSwitch switchLockAutoClose, Boolean enable) {
        if (enable != null) {
            switchLockAutoClose.setChecked(enable.booleanValue());
        }
    }

    public /* synthetic */ void lambda$initWindow$49$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public static /* synthetic */ void lambda$initWindow$50(final XSwitch switchHighSpdCloseWin, Boolean enable) {
        if (enable != null) {
            switchHighSpdCloseWin.setChecked(enable.booleanValue());
        }
    }

    public static /* synthetic */ boolean lambda$initWindow$51(View buttonView, boolean isChecked) {
        if (buttonView.isPressed()) {
    ...
    public /* synthetic */ void lambda$initWindow$52$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public static /* synthetic */ void lambda$initWindow$53(final XSwitch mSwitchOpenSdcWithWin, Boolean enable) {
        if (enable != null) {
    ...
    public void updateDoorAngle(Integer angle) {
        ...
        this.mDoorAngleSlider.postDelayed(new Runnable() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$9hGnzUm3RjioMXOJ_iFQJhq2M_o
            @Override // java.lang.Runnable
            public final void run() {
                SettingsFragment.this.lambda$updateDoorAngle$54$SettingsFragment(round);
            }
        }, 200L);
    }

    public /* synthetic */ void lambda$updateDoorAngle$54$SettingsFragment(final int slideIndex) {
    ...
    private void initChildLock(View container) {
        ...
        if (isSupportChildMode) {
            ...
            this.mChildModeLayout.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$GWBGDsnEjcrZHDcVzfdVlSE5hHc
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SettingsFragment.this.lambda$initChildLock$55$SettingsFragment(view);
                }
            });
            updateChildModeView(this.mCarBodyViewModel.isChildModeEnable());
            setLiveDataObserver(this.mCarBodyViewModel.getChildMode(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$yCsXyiduZ_-CQ6HTJpxnQc9t9ng
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initChildLock$56$SettingsFragment((Boolean) obj);
                }
            });
            return;
        }
        ...
        this.leftChildLockTB.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$rbTPtuR6jjr0rgf9yVywoeVJMe8
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return SettingsFragment.lambda$initChildLock$57(view, motionEvent);
            }
        });
        this.leftChildLockTB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$s8pEjJmnDUotRUx7EUUEBJcmlOU
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                SettingsFragment.this.lambda$initChildLock$58$SettingsFragment(compoundButton, z);
            }
        });
        ...
        this.rightChildLockTB.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$dXktLuS1KJ1uwTYpY8ocO-3yNwg
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return SettingsFragment.lambda$initChildLock$59(view, motionEvent);
            }
        });
        this.rightChildLockTB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$1xkUDCt47ftoYx0l8vHcBVHWvhc
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                SettingsFragment.this.lambda$initChildLock$60$SettingsFragment(compoundButton, z);
            }
        });
        this.rightChildLockTB.setChecked(this.mCarBodyViewModel.isRightChildLocked());
    ...
    public /* synthetic */ void lambda$initChildLock$55$SettingsFragment(View v) {
        showChildModePanel();
    }

    public /* synthetic */ void lambda$initChildLock$56$SettingsFragment(Boolean enable) {
        updateChildModeView(enable.booleanValue());
    }

    public static /* synthetic */ boolean lambda$initChildLock$57(View v, MotionEvent event) {
        return event.getAction() == 0 && ClickHelper.isFastClick(500L);
    }

    public /* synthetic */ void lambda$initChildLock$58$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public static /* synthetic */ boolean lambda$initChildLock$59(View v, MotionEvent event) {
        return event.getAction() == 0 && ClickHelper.isFastClick(500L);
    }

    public /* synthetic */ void lambda$initChildLock$60$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    private void initWelcome(View container) {
        ...
        if (CarBaseConfig.getInstance().isSupportWelcomeMode()) {
            ...
            this.mSeatWelcomeSw.setChecked(isWelcomeModeEnabled);
            this.mSeatWelcomeSw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$P-ii6crDrrpfkqhS36xSsxzAUWg
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initWelcome$61$SettingsFragment(compoundButton, z);
                }
            });
        ...
        if (CarBaseConfig.getInstance().isSupportPsnWelcomeMode()) {
            ...
            this.mPsnSeatWelcomeSw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$_3X682-RZbVzXeGiJSyGuPZsUUI
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initWelcome$62$SettingsFragment(compoundButton, z);
                }
            });
        ...
        if (CarBaseConfig.getInstance().isSupportRearSeatWelcomeMode()) {
            ...
            this.mRearSeatWelcomeSw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$Klei00YOMYBXvIiCeTuhLpBrfNY
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initWelcome$63$SettingsFragment(compoundButton, z);
                }
            });
        }
        if (CarBaseConfig.getInstance().isSupportBootSoundEffect()) {
            ...
            this.mBootEffectSw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$UNsTSJBfveEKG_sB_5wCyjN-Nj8
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initWelcome$64$SettingsFragment(compoundButton, z);
                }
            });
            ...
            this.mBootEffectTab.setOnTabChangeListener(new XTabLayout.OnTabChangeListenerAdapter() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.9
                {
                    SettingsFragment.this = this;
                }
    ...
    public /* synthetic */ void lambda$initWelcome$61$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ void lambda$initWelcome$62$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ void lambda$initWelcome$63$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ void lambda$initWelcome$64$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        int i;
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    private void initDrive(View view) {
        if (BaseFeatureOption.getInstance().isSupportDriveInSettingsPage()) {
            if (CarBaseConfig.getInstance().isSupportShowEps()) {
                ...
                setLiveDataObserver(this.mChassisVm.getSteeringEpsData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$1UCN_GvxTjYUfyDNUSDt8hR55yA
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.this.lambda$initDrive$65$SettingsFragment(xTabLayout, (SteeringEpsMode) obj);
                    }
                });
            ...
            if (isSupportEpbSetting || isSupportTrailerMode) {
                ...
                if (isSupportEpbSetting) {
                    ...
                    this.mEpbLayout.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$-cScj8yWwVhtQ9cuDAqwqYDynwc
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            SettingsFragment.this.lambda$initDrive$66$SettingsFragment(view2);
                        }
                    });
                    setLiveDataObserver(this.mVcuViewModel.getGearLevelData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$YxSGDyCdEY8YA92jI9mVy44hbxw
                        @Override // androidx.lifecycle.Observer
                        public final void onChanged(Object obj) {
                            SettingsFragment.this.lambda$initDrive$67$SettingsFragment((GearLevel) obj);
                        }
                    });
                    setLiveDataObserver(this.mChassisVm.getApbStatusData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$o3QvQL3yZ8bdLOXm2X5MS6SgpgI
                        @Override // androidx.lifecycle.Observer
                        public final void onChanged(Object obj) {
                            SettingsFragment.this.lambda$initDrive$68$SettingsFragment((Integer) obj);
                        }
                    });
                ...
                if (isSupportTrailerMode) {
                    ...
                    view.findViewById(R.id.trailer_mode_layout).setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$jadw3vLbtJAmn4sgRsk4tQGatRU
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            SettingsFragment.this.lambda$initDrive$69$SettingsFragment(view2);
                        }
                    });
                }
            }
            if (CarBaseConfig.getInstance().isSupportTrailerHook()) {
                ...
                setLiveDataObserver(this.mChassisVm.getTtmSwitchData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$vU3RMqOLdL5no-fo075Amu_MHZI
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.this.lambda$initDrive$70$SettingsFragment((TrailerHitchStatus) obj);
                    }
                });
                setLiveDataObserver(this.mChassisVm.getTrailerModeData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$uxYL61ZcN_8UEC9XplWadXVBy24
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.this.lambda$initDrive$71$SettingsFragment((Boolean) obj);
                    }
                });
                this.mTrailerLayout.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$Pa6thkU-QAEkbKHcmlSXk92tPAg
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        SettingsFragment.this.lambda$initDrive$72$SettingsFragment(view2);
                    }
                });
            }
            if (CarBaseConfig.getInstance().isSupportAirSuspension()) {
                ...
                findViewById.setVisibility(0);
                XSwitch xSwitch = (XSwitch) findViewById.findViewById(R.id.x_list_sw);
                xSwitch.setOnInterceptListener(new XSwitch.OnInterceptListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$YVzVZkcmrWBxk14-1Gs6j8RdFog
                    @Override // com.xiaopeng.xui.widget.XSwitch.OnInterceptListener
                    public final boolean onInterceptCheck(View view2, boolean z2) {
                        return SettingsFragment.this.lambda$initDrive$73$SettingsFragment(view2, z2);
                    }
                });
                xSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$trmAOtNM4bhJTtfU8FLe2K7_wlA
                    @Override // android.widget.CompoundButton.OnCheckedChangeListener
                    public final void onCheckedChanged(CompoundButton compoundButton, boolean z2) {
                        SettingsFragment.this.lambda$initDrive$74$SettingsFragment(compoundButton, z2);
                    }
                });
            ...
            xSwitch2.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$6UXzEAwI7Fl3pw94VGb9IQGbZuA
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return SettingsFragment.this.lambda$initDrive$75$SettingsFragment(view2, motionEvent);
                }
            });
            xSwitch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$n4qv9fXwpH-k2hddi8hzDg-fhgw
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z2) {
                    SettingsFragment.this.lambda$initDrive$76$SettingsFragment(compoundButton, z2);
                }
            });
            ...
            setLiveDataObserver(this.mChassisVm.getAvhFaultData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$EWVJSB6GU6EjbAOb0OldiZ0Z9rQ
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initDrive$77$SettingsFragment(xSwitch2, (Boolean) obj);
                }
            });
            ...
            if (CarBaseConfig.getInstance().isSupportHdc()) {
                ...
                xSwitch3.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$fy9tW9GnGsNniJuEnVkNc6aPw4A
                    @Override // android.view.View.OnTouchListener
                    public final boolean onTouch(View view2, MotionEvent motionEvent) {
                        return SettingsFragment.this.lambda$initDrive$78$SettingsFragment(xSwitch3, view2, motionEvent);
                    }
                });
                setLiveDataObserver(this.mChassisVm.getHdcData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$ZeAnhC2levMCyRbuyBIxQZ7qknI
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.lambda$initDrive$79(XSwitch.this, (Boolean) obj);
                    }
                });
                setLiveDataObserver(this.mChassisVm.getHdcFaultData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$Vi1Syr5Lwh1izwEkqaFeH4iy1eg
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.this.lambda$initDrive$80$SettingsFragment(xSwitch3, (Boolean) obj);
                    }
                });
            ...
            xSwitch4.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$SUs0zD6ZxO2K92u7VaLvSearpww
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return SettingsFragment.this.lambda$initDrive$81$SettingsFragment(view2, motionEvent);
                }
            });
            xSwitch4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$K3IMwdJVznrfMV1wslLdpy0riYU
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z2) {
                    SettingsFragment.this.lambda$initDrive$83$SettingsFragment(xSwitch4, compoundButton, z2);
                }
            });
            setLiveDataObserver(this.mChassisVm.getEspModeData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$QDI-WNiW3gDrWyBRGE0gesNuhx0
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initDrive$84$SettingsFragment(xSwitch4, (Boolean) obj);
                }
            });
            setLiveDataObserver(this.mChassisVm.getEspFaultData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$1HAbE01yeekeDXElAvr7pFxFDT4
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initDrive$85$SettingsFragment(xSwitch4, (Boolean) obj);
                }
            });
            ...
            if (CarBaseConfig.getInstance().isSupportTrailerRv() && !CarBaseConfig.getInstance().isSupportTrailerHook()) {
                ...
                xSwitch5.setOnInterceptListener(new XSwitch.OnInterceptListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$YbdHLrV5cUkCD0m62CjuhslVsf0
                    @Override // com.xiaopeng.xui.widget.XSwitch.OnInterceptListener
                    public final boolean onInterceptCheck(View view2, boolean z2) {
                        return SettingsFragment.this.lambda$initDrive$86$SettingsFragment(view2, z2);
                    }
                });
                xSwitch5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$T07mb-ajH88wn1cjAAD8BO5gKK4
                    @Override // android.widget.CompoundButton.OnCheckedChangeListener
                    public final void onCheckedChanged(CompoundButton compoundButton, boolean z2) {
                        SettingsFragment.this.lambda$initDrive$87$SettingsFragment(compoundButton, z2);
                    }
                });
            }
            ...
            if (CarBaseConfig.getInstance().isSupportSnowMode()) {
                ...
                xSwitch6.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$cNs9-DWzx22lM0INpxJ4zKiJq8s
                    @Override // android.view.View.OnTouchListener
                    public final boolean onTouch(View view2, MotionEvent motionEvent) {
                        return SettingsFragment.this.lambda$initDrive$88$SettingsFragment(view2, motionEvent);
                    }
                });
                xSwitch6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$zDPgmMIIevwh4gI9qPElrS9Be88
                    @Override // android.widget.CompoundButton.OnCheckedChangeListener
                    public final void onCheckedChanged(CompoundButton compoundButton, boolean z2) {
                        SettingsFragment.this.lambda$initDrive$89$SettingsFragment(compoundButton, z2);
                    }
                });
                setLiveDataObserver(this.mVcuViewModel.getSnowModeData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$OZArEI-O4X7A_WhSYDP08e77i3E
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.lambda$initDrive$90(XSwitch.this, (Boolean) obj);
                    }
                });
    ...
    public /* synthetic */ void lambda$initDrive$65$SettingsFragment(final XTabLayout epsTab, SteeringEpsMode mode) {
        if (mode != null) {
            if (CarBaseConfig.getInstance().isSupportXSport() && (XSportDriveMode.XPower == this.mVcuViewModel.getXSportDriveModeValue() || XSportDriveMode.Geek == this.mVcuViewModel.getXSportDriveModeValue())) {
    ...
    public /* synthetic */ void lambda$initDrive$66$SettingsFragment(View v) {
        this.mChassisVm.controlEpb();
    }

    public /* synthetic */ void lambda$initDrive$67$SettingsFragment(GearLevel gearLevel) {
        if (gearLevel != null) {
            updateEpbView(gearLevel != GearLevel.P, this.mChassisVm.getApbSystemStatus());
        }
    }

    public /* synthetic */ void lambda$initDrive$68$SettingsFragment(Integer status) {
        if (status != null) {
            updateEpbView(this.mVcuViewModel.getGearLevelValue() != GearLevel.P, status.intValue());
        }
    }

    public /* synthetic */ void lambda$initDrive$69$SettingsFragment(View v) {
    ...
    public /* synthetic */ void lambda$initDrive$70$SettingsFragment(TrailerHitchStatus status) {
        updateTrailerContentView(status, this.mChassisVm.getTrailerModeStatus());
    }

    public /* synthetic */ void lambda$initDrive$71$SettingsFragment(Boolean enable) {
        updateTrailerContentView(this.mChassisVm.getTrailerHitchStatus(), enable.booleanValue());
    }

    public /* synthetic */ void lambda$initDrive$72$SettingsFragment(View v) {
        showTrailerModePanel();
    }

    public /* synthetic */ boolean lambda$initDrive$73$SettingsFragment(View buttonView, boolean isChecked) {
        if (buttonView.isPressed() && isChecked) {
    ...
    public /* synthetic */ void lambda$initDrive$74$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed()) {
            this.mChassisVm.setEasyLoadingSwitch(isChecked);
        }
    }

    public /* synthetic */ boolean lambda$initDrive$75$SettingsFragment(View v, MotionEvent event) {
        if (event.getAction() == 1) {
    ...
    public /* synthetic */ void lambda$initDrive$76$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ void lambda$initDrive$77$SettingsFragment(final XSwitch mAvhSw, Boolean isFault) {
    ...
    public /* synthetic */ boolean lambda$initDrive$78$SettingsFragment(final XSwitch mHdcSw, View v, MotionEvent event) {
        if (event.getAction() != 1) {
            return false;
        }
    ...
    public static /* synthetic */ void lambda$initDrive$79(final XSwitch mHdcSw, Boolean enabled) {
        if (enabled != null) {
            mHdcSw.setChecked(enabled.booleanValue());
        }
    }

    public /* synthetic */ void lambda$initDrive$80$SettingsFragment(final XSwitch mHdcSw, Boolean isFault) {
        if (isFault != null) {
            if (isFault.booleanValue()) {
    ...
    public /* synthetic */ boolean lambda$initDrive$81$SettingsFragment(View v, MotionEvent event) {
        if (event.getAction() == 1) {
            if (CarBaseConfig.getInstance().isSupportXSport()) {
    ...
    public /* synthetic */ void lambda$initDrive$83$SettingsFragment(final XSwitch mEspSw, CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
            if (this.mChassisVm.getEspSw() && this.mVcuViewModel.getCarSpeed() > 80.0f) {
                ...
                ThreadUtils.runOnMainThread(new Runnable() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$So9_aIZW0ypXKrurkW3uSkJxSmg
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ void lambda$initDrive$84$SettingsFragment(final XSwitch mEspSw, Boolean enable) {
        mEspSw.setChecked(this.mChassisVm.getEspForUI());
    }

    public /* synthetic */ void lambda$initDrive$85$SettingsFragment(final XSwitch mEspSw, Boolean fault) {
        mEspSw.setChecked(this.mChassisVm.getEspForUI());
    }

    public /* synthetic */ boolean lambda$initDrive$86$SettingsFragment(View buttonView, boolean isChecked) {
        if (buttonView.isPressed() && isChecked) {
    ...
    public /* synthetic */ void lambda$initDrive$87$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if ((buttonView.isPressed() || isVuiAction(buttonView)) && !isChecked) {
            this.mChassisVm.setTrailerModeStatus(false);
        }
    }

    public /* synthetic */ boolean lambda$initDrive$88$SettingsFragment(View v, MotionEvent event) {
        if (event.getAction() != 1) {
            return false;
        }
    ...
    public /* synthetic */ void lambda$initDrive$89$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public static /* synthetic */ void lambda$initDrive$90(final XSwitch mSnowSw, Boolean enable) {
        if (enable != null) {
    ...
    public /* synthetic */ void lambda$showTrailerModeOpenConfirmDialog$91$SettingsFragment(XDialog xDialog, int i) {
    ...
    private void initAvasSpeaker(View view) {
        if (CarBaseConfig.getInstance().isSupportAvasLoudSpeaker()) {
            ...
            xSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$bMXS4kwOH7yFWwRfbGpZ_QPRLrc
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initAvasSpeaker$92$SettingsFragment(compoundButton, z);
                }
            });
        }
    }

    public /* synthetic */ void lambda$initAvasSpeaker$92$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    private void initAirSuspension(View container) {
        if (CarBaseConfig.getInstance().isSupportAsWelcomeMode()) {
            ...
            xSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$GBVMhd4gwHTDD4rv1McBf3lkEnI
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initAirSuspension$93$SettingsFragment(compoundButton, z);
                }
            });
    ...
    public /* synthetic */ void lambda$initAirSuspension$93$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    private void initBelt(View container) {
        ...
        if (CarBaseConfig.getInstance().isSupportEsb()) {
            ...
            this.switchDrvEsb.setOnInterceptListener(new XSwitch.OnInterceptListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$iA6jY1ozIA1fx83uVecpLSaSg8k
                @Override // com.xiaopeng.xui.widget.XSwitch.OnInterceptListener
                public final boolean onInterceptCheck(View view, boolean z3) {
                    return SettingsFragment.this.lambda$initBelt$94$SettingsFragment(view, z3);
                }
            });
            this.switchDrvEsb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$9_-IwL9Khe1NLKbHjnHlFaUQ42M
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z3) {
                    SettingsFragment.this.lambda$initBelt$95$SettingsFragment(compoundButton, z3);
                }
            });
            this.switchDrvEsb.setChecked(this.mSeatViewModel.getEsbMode());
            setLiveDataObserver(this.mSeatViewModel.getEsbModeData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$92CPEbOlYwmQ47JBdUg8V2P4dGM
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initBelt$96$SettingsFragment((Boolean) obj);
                }
            });
            updateDrvEsbConfigMode(this.mSeatViewModel.getEsbConfigMode());
            setLiveDataObserver(this.mSeatViewModel.getEsbConfigModeData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$4j1Od9-5FpB3AAyizADs_XAjr3E
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initBelt$97$SettingsFragment((String) obj);
                }
            });
        ...
        if (CarBaseConfig.getInstance().isSupportRearBeltWarningSwitch()) {
            ...
            xSwitch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$yqoUfxlQ0rtt8iEkS1SXPRoYYi8
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z3) {
                    SettingsFragment.this.lambda$initBelt$98$SettingsFragment(compoundButton, z3);
                }
            });
        ...
        if (CarBaseConfig.getInstance().isSupportPsnSrsSwitch()) {
            ...
            this.mPsnSrsSw.setOnInterceptListener(new XSwitch.OnInterceptListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$Jmqq7nnGKPW0fSPyRZDMsFnEkoY
                @Override // com.xiaopeng.xui.widget.XSwitch.OnInterceptListener
                public final boolean onInterceptCheck(View view, boolean z3) {
                    return SettingsFragment.this.lambda$initBelt$99$SettingsFragment(view, z3);
                }
            });
    ...
    public /* synthetic */ boolean lambda$initBelt$94$SettingsFragment(View buttonView, boolean isChecked) {
        if (!buttonView.isPressed() || isChecked) {
            return false;
        }
    ...
    public /* synthetic */ void lambda$initBelt$95$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if ((buttonView.isPressed() || isVuiAction(buttonView)) && isChecked) {
    ...
    public /* synthetic */ void lambda$initBelt$96$SettingsFragment(Boolean enabled) {
        LogUtils.i(this.TAG, "update drv esb sw : " + enabled);
        this.switchDrvEsb.setChecked(enabled.booleanValue());
    }

    public /* synthetic */ void lambda$initBelt$97$SettingsFragment(String configMode) {
    ...
    public /* synthetic */ void lambda$initBelt$98$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ boolean lambda$initBelt$99$SettingsFragment(View buttonView, boolean isChecked) {
        boolean z = false;
        if (buttonView.isPressed()) {
            z = true;
    ...
    private void showCloseSafeBeltDialog() {
        ...
        if (this.mSafeBeltDialog == null && getActivity() != null) {
            ...
            XDialog onDismissListener = new XDialog(getActivity(), R.style.show_close_safe_belt_dialog).setTitle(i).setMessage(i2).setNegativeButton(getStringById(R.string.btn_cancel), (XDialogInterface.OnClickListener) null).setPositiveButton(getStringById(R.string.btn_confirm), new XDialogInterface.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$DXlJliuCKUgjgsqqDGDrdLrY0sM
                @Override // com.xiaopeng.xui.app.XDialogInterface.OnClickListener
                public final void onClick(XDialog xDialog, int i3) {
                    SettingsFragment.this.lambda$showCloseSafeBeltDialog$100$SettingsFragment(xDialog, i3);
                }
            }).setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$rdFNBcQQkt-lawZm-ZeSTuWsMyw
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    SettingsFragment.this.lambda$showCloseSafeBeltDialog$101$SettingsFragment(dialogInterface);
                }
            });
    ...
    public /* synthetic */ void lambda$showCloseSafeBeltDialog$100$SettingsFragment(XDialog xDialog, int i) {
        this.mSeatViewModel.setEsbMode(false);
        this.mIsDrvEsbConfirmed = true;
    }

    public /* synthetic */ void lambda$showCloseSafeBeltDialog$101$SettingsFragment(DialogInterface dialog) {
    ...
    */
    ...
    private void initWheel(View container) {
        if (CarBaseConfig.getInstance().isSupportWheelSetting()) {
            ...
            if (CarBaseConfig.getInstance().isSupportWheelKeyProtect()) {
                ...
                this.mWheelProtectSw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$218z9v3SjQFEGtzLSFQgOKOHN58
                    @Override // android.widget.CompoundButton.OnCheckedChangeListener
                    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                        SettingsFragment.this.lambda$initWheel$102$SettingsFragment(compoundButton, z);
                    }
                });
                this.mWheelProtectSw.setChecked(this.mMeterViewModel.isWheelKeyProtectEnabled());
            } else {
            ...
            if (CarBaseConfig.getInstance().isSupportNeutralGearProtect()) {
                ...
                xSwitch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$mlABcHh7_EUiBQLcpKtjTLWbbd4
                    @Override // android.widget.CompoundButton.OnCheckedChangeListener
                    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                        SettingsFragment.this.lambda$initWheel$103$SettingsFragment(compoundButton, z);
                    }
                });
                xSwitch2.setChecked(this.mVcuViewModel.getNGearWarningSwitchStatus());
                setLiveDataObserver(this.mVcuViewModel.getNGearWarningSwData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$9FxBNPDDf0hHDP_6XplNTPTdjkw
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj) {
                        SettingsFragment.lambda$initWheel$104(XSwitch.this, (Boolean) obj);
                    }
                });
                return;
            }
    ...
    public /* synthetic */ void lambda$initWheel$102$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ void lambda$initWheel$103$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public static /* synthetic */ void lambda$initWheel$104(final XSwitch mNStallSw, Boolean enable) {
        if (enable != null) {
    ...
    private void initCwc(View container) {
        if (CarBaseConfig.getInstance().isSupportCwc()) {
            ...
            customXSwitch.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$iYD_8iE5pVSjowU1kF4dsdPRBik
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return SettingsFragment.this.lambda$initCwc$105$SettingsFragment(customXSwitch, view, motionEvent);
                }
            });
            customXSwitch.setChecked(this.mCarBodyViewModel.isCwcSwEnable());
            setLiveDataObserver(this.mCarBodyViewModel.getCwcSwData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$qO13wr_UD4MzwOep3IIkFESJBDc
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.lambda$initCwc$106(CustomXSwitch.this, (Boolean) obj);
                }
            });
        }
    }

    public /* synthetic */ boolean lambda$initCwc$105$SettingsFragment(final CustomXSwitch cwcSw, View v, MotionEvent event) {
        if (event.getAction() != 1) {
            return false;
        }
    ...
    public static /* synthetic */ void lambda$initCwc$106(final CustomXSwitch cwcSw, Boolean enable) {
        if (enable != null) {
    ...
    private void initMeterAndKeys(View container) {
        ...
        if (isSupportMeterSetting) {
            ...
            xButton.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$F1irkE8GjmDc04gJDgv5USGPBmU
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SettingsFragment.this.lambda$initMeterAndKeys$107$SettingsFragment(view);
                }
            });
        }
        if (isSupportMeterSetting) {
            ...
            this.mSpdLimitSd.setSliderProgressListener(new XSlider.SliderProgressListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.11
                @Override // com.xiaopeng.xui.widget.slider.XSlider.SliderProgressListener
            ...
            this.mSpdLimitSd.setProgressChangeListener(new XSlider.ProgressChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$LjEhjU_nR5JclbQ_Fg_XkzU9n_o
                @Override // com.xiaopeng.xui.widget.slider.XSlider.ProgressChangeListener
                public final void onProgressChanged(XSlider xSlider, float f, String str, boolean z) {
                    SettingsFragment.this.lambda$initMeterAndKeys$108$SettingsFragment(xSlider, f, str, z);
                }
            });
            xSwitch.setOnTouchListener(new View.OnTouchListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$Cf474Dw9KCCLxiDv7IAqYQchqa0
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return SettingsFragment.lambda$initMeterAndKeys$109(view, motionEvent);
                }
            });
            xSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$jGiWj19xt-opu2BL5s_z3qfiwsk
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initMeterAndKeys$110$SettingsFragment(compoundButton, z);
                }
            });
            setLiveDataObserver(this.mMeterViewModel.getSpdWarningSwData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$1VTX_bWqLEAtU59bZE_jCD7b7-c
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initMeterAndKeys$111$SettingsFragment(xSwitch, (Boolean) obj);
                }
            });
            this.mSpdLimitSd.postDelayed(new Runnable() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$kbpPI2GbM6Z7AF3OqSHyzZ1hvxc
                @Override // java.lang.Runnable
                public final void run() {
                    SettingsFragment.this.lambda$initMeterAndKeys$112$SettingsFragment(xSwitch);
                }
            }, 200L);
        ...
        xButton2.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$xkBUS0hDejFQbNwixGa8FDsRh_0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SettingsFragment.this.lambda$initMeterAndKeys$113$SettingsFragment(view);
            }
        });
        ...
        setLiveDataObserver(this.mMeterViewModel.getXKeyData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$QzDtbX8CQPapxGOzH7qkH920LMM
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                SettingsFragment.this.lambda$initMeterAndKeys$114$SettingsFragment((XKeyForCustomer) obj);
            }
        });
        ...
        if (CarBaseConfig.getInstance().isSupportDoorKeySetting()) {
            ...
            xButton3.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$3akrmNxReOqE5qIFSlVeDHoy36g
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SettingsFragment.this.lambda$initMeterAndKeys$115$SettingsFragment(view);
                }
            });
            ...
            setLiveDataObserver(this.mMeterViewModel.getDoorKeyData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$QnFN5J5hQRKoO6v3pbHZS9MDBT4
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initMeterAndKeys$116$SettingsFragment((DoorKeyForCustomer) obj);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void lambda$initMeterAndKeys$107$SettingsFragment(View v) {
        showMeterMenuDialog();
        StatisticUtils.sendStatistic(PageEnum.SETTING_PAGE, BtnEnum.INSTRMENT_CUSTOM_MENU_BTN, new Object[0]);
    }

    public /* synthetic */ void lambda$initMeterAndKeys$108$SettingsFragment(XSlider xSlider, float v, String s, boolean b) {
        onSpeedSliderChange();
    }

    public static /* synthetic */ boolean lambda$initMeterAndKeys$109(View v, MotionEvent event) {
        return event.getAction() == 0 && ClickHelper.isFastClick(v.getId(), 500L, false);
    }

    public /* synthetic */ void lambda$initMeterAndKeys$110$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    public /* synthetic */ void lambda$initMeterAndKeys$111$SettingsFragment(final XSwitch spdWaringSw, Boolean enable) {
        if (enable != null) {
    ...
    public /* synthetic */ void lambda$initMeterAndKeys$112$SettingsFragment(final XSwitch spdWaringSw) {
    ...
    public /* synthetic */ void lambda$initMeterAndKeys$113$SettingsFragment(View v) {
        Intent intent = new Intent(this.mContext, CarControlService.class);
    ...
    public /* synthetic */ void lambda$initMeterAndKeys$114$SettingsFragment(XKeyForCustomer xKeyForCustomer) {
    ...
    public /* synthetic */ void lambda$initMeterAndKeys$115$SettingsFragment(View v) {
        Intent intent = new Intent(this.mContext, CarControlService.class);
    ...
    public /* synthetic */ void lambda$initMeterAndKeys$116$SettingsFragment(DoorKeyForCustomer doorKeyForCustomer) {
    ...
    public void updateSpdLimitValue(Integer limit) {
        ...
        this.mSpdLimitSd.post(new Runnable() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$oNr8JezegP8c0Cc1_owQM04QdH8
            @Override // java.lang.Runnable
            public final void run() {
                SettingsFragment.this.lambda$updateSpdLimitValue$117$SettingsFragment(round);
            }
        });
    }

    public /* synthetic */ void lambda$updateSpdLimitValue$117$SettingsFragment(final int slideIndex) {
    ...
    private void initOthers(View container) {
        if (BaseFeatureOption.getInstance().isSupportLightMeHomeInSettings()) {
            ...
            xTabLayout.setOnTabChangeListener(new XTabLayout.OnTabChangeListenerAdapter() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.12
                {
                    SettingsFragment.this = this;
                }
            ...
            setLiveDataObserver(this.mLampViewModel.getLightMeHomeTimeData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$_0sg15ZjJ6MWHF5ti3pQUs57S5I
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initOthers$118$SettingsFragment((LightMeHomeTime) obj);
                }
            });
        ...
        if (CarBaseConfig.getInstance().isSupportMirrorDown()) {
            ...
            xSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$sruBPKRx7qWYFzsz3fvbEdYv3Kk
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initOthers$119$SettingsFragment(compoundButton, z);
                }
            });
            xSwitch.setChecked(this.mMirrorViewModel.isMirrorAutoDown());
            setLiveDataObserver(this.mMirrorViewModel.getMirrorAutoDownData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$WDTGAOQdqzf6xq0gKsT-NWh96EQ
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.lambda$initOthers$120(XSwitch.this, (Boolean) obj);
                }
            });
        }
        if (BaseFeatureOption.getInstance().isSupportMirrorMemoryInSettings()) {
            ...
            xSwitch2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$5SsoDfpEeEVmgpFwAkusyqe4Lvg
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initOthers$121$SettingsFragment(compoundButton, z);
                }
            });
            xSwitch3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$JkCg73ZC77BmKT8rbQESb2fSqxI
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initOthers$122$SettingsFragment(compoundButton, z);
                }
            });
            xSwitch2.setChecked(this.mMirrorViewModel.getLMReverseSw());
            xSwitch3.setChecked(this.mMirrorViewModel.getRMReverseSw());
            setLiveDataObserver(this.mMirrorViewModel.getMirrorReverseData(), new Observer() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$D_WzLF5y4dtjBW1DeSgnOAe8q4s
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    SettingsFragment.this.lambda$initOthers$123$SettingsFragment(xSwitch2, xSwitch3, (MirrorReverseMode) obj);
                }
            });
        }
        if (CarBaseConfig.getInstance().isSupportAutoPowerOff()) {
            ...
            xSwitch4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.-$$Lambda$SettingsFragment$-h5wkAPn-SPHY6sqo6htJc9IkK4
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    SettingsFragment.this.lambda$initOthers$124$SettingsFragment(compoundButton, z);
                }
            });
    ...
    public /* synthetic */ void lambda$initOthers$118$SettingsFragment(LightMeHomeTime lightMeHomeTime) {
        if (lightMeHomeTime != null) {
            updateLightMeHome(lightMeHomeTime);
        }
    }

    public /* synthetic */ void lambda$initOthers$119$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
            this.mMirrorViewModel.setMirrorAutoDown(isChecked);
        }
    }

    public static /* synthetic */ void lambda$initOthers$120(final XSwitch mirrorAutoDownSw, Boolean enabled) {
        if (enabled != null) {
            mirrorAutoDownSw.setChecked(enabled.booleanValue());
        }
    }

    public /* synthetic */ void lambda$initOthers$121$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
            this.mMirrorViewModel.setLMReverseSw(isChecked);
        }
    }

    public /* synthetic */ void lambda$initOthers$122$SettingsFragment(CompoundButton buttonView, boolean isChecked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
            this.mMirrorViewModel.setRMReverseSw(isChecked);
        }
    }

    public /* synthetic */ void lambda$initOthers$123$SettingsFragment(final XSwitch leftRmSw, final XSwitch rightRmSw, MirrorReverseMode mirrorReverseMode) {
    ...
    public /* synthetic */ void lambda$initOthers$124$SettingsFragment(CompoundButton buttonView, boolean checked) {
        if (buttonView.isPressed() || isVuiAction(buttonView)) {
    ...
    private void updateLightMeHome(LightMeHomeTime time) {
        int i = AnonymousClass14.$SwitchMap$com$xiaopeng$carcontrol$viewmodel$lamp$LightMeHomeTime[time.ordinal()];
        int i2 = 3;
        if (i == 1) {
            i2 = 0;
        } else if (i == 2) {
    ...
    public boolean onInterceptVuiEvent(View view, VuiEvent vuiEvent) {
        ...
        if (vuiEvent.getHitVuiElement().getId().contains(String.valueOf(R.id.listtwo_drive_experience_avh))) {
            ...
            if (CarBaseConfig.getInstance().isSupportSrrMiss()) {
                ...
                int i = AnonymousClass14.$SwitchMap$com$xiaopeng$carcontrol$viewmodel$scu$DsmState[this.mScuViewModel.getDsmState().ordinal()];
                if (i == 1) {
    ...
    /* renamed from: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment$14 */
    /* loaded from: classes2.dex */
    ...
    public /* synthetic */ void lambda$onInterceptVuiEvent$125$SettingsFragment(XDialog xDialog, int i) {
        this.mScuViewModel.setDsmSw(false);
        this.mDsmSw.setChecked(false);
    }
        ...
        if (BaseFeatureOption.getInstance().isSupportLeftCarImgChange() && this.operationType != type) {
            ...
            if (this.mTopCarResId != 0) {
                ...
                if (this.mAnimListener == null) {
                    AnimatorListenerAdapter animatorListenerAdapter = new AnimatorListenerAdapter() { // from class: com.xiaopeng.carcontrol.view.fragment.impl.SettingsFragment.13
                        {
                            SettingsFragment.this = this;
                        }
