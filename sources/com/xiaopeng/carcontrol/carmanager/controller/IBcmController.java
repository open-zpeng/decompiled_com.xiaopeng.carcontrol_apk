...
public interface IBcmController extends IBaseCarController<Callback> {
    ...
    public interface Callback extends IBaseCallback {
        ...
        default void onLockResponseNewChanged(int type) {
        }
        ...
        default void onUnLockResponseNewChanged(int type) {
        }
    ...
    void setLockResponseNew(int type);
    ...
    void setUnLockResponseNew(int type);
