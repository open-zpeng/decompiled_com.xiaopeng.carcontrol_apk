...
public class BcmController extends BaseCarController<CarBcmManager, IBcmController.Callback> implements IBcmController {
    ...
    private Integer mLockResponseNew = null;
    private Integer mUnLockResponseNew = null;
    private Boolean mIsHighSpdWinClose = null;
    NoConcurrenceRunnable mFixElcTrunkState = new NoConcurrenceRunnable(new Runnable() { // from class: com.xiaopeng.carcontrol.carmanager.impl.-$$Lambda$BcmController$meoVDllJQT9XMqV_jrZ9MHe4gKM
        @Override // java.lang.Runnable
        public final void run() {
            BcmController.this.lambda$new$12$BcmController();
        }
    });
    ...
    */
    public boolean isParkLampIncludeFmB() {
        /*
            ...
            boolean r0 = r0.isSupportSaberLightMode()
            r1 = 0
            if (r0 == 0) goto L82
            r0 = 1
    ...
    */
    ...
    @Override // com.xiaopeng.carcontrol.carmanager.controller.IBcmController
    public int getLockResponseNewSp() {
        if (this.mCarConfig.isSupportLockUnLockRspSep() && this.mIsMainProcess) {
            return this.mDataSync.getLockResponseNew();
        }
        return GlobalConstant.DEFAULT.LOCK_RESPONSE_NEW;
    }

    @Override // com.xiaopeng.carcontrol.carmanager.controller.IBcmController
    public void setLockResponseNew(final int type) {
        if (this.mCarConfig.isSupportLockUnLockRspSep()) {
            try {
                LogUtils.i(TAG, "setLockResponseNew: " + type, false);
                int i = 1;
                this.mCarManager.setLockHazardLightSwitchStatus(1);
                CarBcmManager carBcmManager = this.mCarManager;
                if (type != 0) {
                ...
                carBcmManager.setLockHornSwitchStatus(i);
                if (this.mIsMainProcess) {
                    this.mDataSync.setLockResponseNew(type);
                    ThreadUtils.execute(new Runnable() { // from class: com.xiaopeng.carcontrol.carmanager.impl.-$$Lambda$BcmController$daJJMJm2xxgjWjhNnsSveHozAIE
                        @Override // java.lang.Runnable
                        public final void run() {
                            BcmController.this.lambda$setLockResponseNew$6$BcmController(type);
                        }
                    });
                }
            } catch (Exception e) {
                LogUtils.e(TAG, "setLockResponseNew: " + e.getMessage(), false);
            }
        }
    }

    @Override // com.xiaopeng.carcontrol.carmanager.controller.IBcmController
    public int getUnLockResponseNewSp() {
        if (this.mCarConfig.isSupportLockUnLockRspSep() && this.mIsMainProcess) {
            return this.mDataSync.getUnLockResponseNew();
        }
        return 1;
    }

    @Override // com.xiaopeng.carcontrol.carmanager.controller.IBcmController
    public void setUnLockResponseNew(final int type) {
        if (this.mCarConfig.isSupportLockUnLockRspSep()) {
            try {
                LogUtils.i(TAG, "setUnLockResponseNew: " + type, false);
                int i = 1;
                this.mCarManager.setUnLockHazardLightSwitchStatus(1);
                CarBcmManager carBcmManager = this.mCarManager;
                if (type != 0) {
                    i = 0;
                }
                carBcmManager.setUnLockHornSwitchStatus(i);
                if (this.mIsMainProcess) {
                    this.mDataSync.setUnLockResponseNew(type);
                    ThreadUtils.execute(new Runnable() { // from class: com.xiaopeng.carcontrol.carmanager.impl.-$$Lambda$BcmController$le1EDAXdmEDxLw2dwGQ3jrbVhzk
                        @Override // java.lang.Runnable
                        public final void run() {
                            BcmController.this.lambda$setUnLockResponseNew$7$BcmController(type);
                        }
                    });
                }
            } catch (Exception e) {
                LogUtils.e(TAG, "setUnLockResponseNew: " + e.getMessage(), false);
            }
        }
    }
    ...
    public void setChildModeEnable(boolean enable, boolean fromUser) {
        ...
        if (enable) {
            ...
            if (CarBaseConfig.getInstance().isSupportNewChildLock()) {
                ...
                setChildLock(true, this.mDataSync.getChildLeftLock() || z2);
                ThreadUtils.execute(new Runnable() { // from class: com.xiaopeng.carcontrol.carmanager.impl.-$$Lambda$BcmController$7kZqGonfvQf6P6-VgrHJWcvkp9I
                    @Override // java.lang.Runnable
                    public final void run() {
                        BcmController.this.lambda$setChildModeEnable$8$BcmController(z2);
                    }
                });
            }
    ...
    public /* synthetic */ void lambda$setChildModeEnable$8$BcmController(final boolean finalNeedForceOpen) {
        try {
            Thread.sleep(650L);
    ...
    */
    ...
    public void setRearSeatWelcomeMode(final boolean enable, boolean needSave) {
        if (this.mCarConfig.isSupportRearSeatWelcomeMode()) {
            ...
            try {
                ...
                ThreadUtils.execute(new Runnable() { // from class: com.xiaopeng.carcontrol.carmanager.impl.-$$Lambda$BcmController$HsI5zVkL0y4S2Z4EUCEuihjbv6c
                    @Override // java.lang.Runnable
                    public final void run() {
                        BcmController.this.lambda$setRearSeatWelcomeMode$9$BcmController(enable);
                    }
                });
            } catch (Exception e) {
    ...
    public void setHighSpdCloseWin(final boolean enable) {
        if (this.mIsMainProcess) {
            ...
            ThreadUtils.execute(new Runnable() { // from class: com.xiaopeng.carcontrol.carmanager.impl.-$$Lambda$BcmController$rtq4DdUY8JfLP_ndokVekiABm1M
                @Override // java.lang.Runnable
                public final void run() {
                    BcmController.this.lambda$setHighSpdCloseWin$10$BcmController(enable);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void lambda$setHighSpdCloseWin$10$BcmController(final boolean enable) {
        if (enable) {
    ...
    */
    ...
    public void setTrailerModeStatus(final boolean enable) {
        if (CarBaseConfig.getInstance().isSupportTrailerRv()) {
            ...
            ThreadUtils.execute(new Runnable() { // from class: com.xiaopeng.carcontrol.carmanager.impl.-$$Lambda$BcmController$693FS9Ae_tdAkvvyDtAVhPvw2f8
                @Override // java.lang.Runnable
                public final void run() {
                    BcmController.this.lambda$setTrailerModeStatus$11$BcmController(enable);
                }
            });
        }
    }
    ...
    */
    ...
    public /* synthetic */ void lambda$new$12$BcmController() {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: handleLockResponseNew */
    public void lambda$setLockResponseNew$6$BcmController(int type) {
        synchronized (this.mCallbackLock) {
            Iterator it = this.mCallbacks.iterator();
            while (it.hasNext()) {
                ((IBcmController.Callback) it.next()).onLockResponseNewChanged(type);
            }
        }
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: handleUnLockResponseNew */
    public void lambda$setUnLockResponseNew$7$BcmController(int type) {
        synchronized (this.mCallbackLock) {
            Iterator it = this.mCallbacks.iterator();
            while (it.hasNext()) {
                ((IBcmController.Callback) it.next()).onUnLockResponseNewChanged(type);
            }
        }
    }
    ...
    public void lambda$setRearSeatWelcomeMode$9$BcmController(boolean enabled) {
        synchronized (this.mCallbackLock) {
            Iterator it = this.mCallbacks.iterator();
            while (it.hasNext()) {
    ...
    private void handleDrvBeltWarningChanged(final int state) {
        synchronized (this.mCallbackLock) {
            this.mCallbacks.forEach(new Consumer() { // from class: com.xiaopeng.carcontrol.carmanager.impl.-$$Lambda$BcmController$L5tGNnNSN8V5kU2dYvJaQkcSeVE
    ...
    public void lambda$setTrailerModeStatus$11$BcmController(boolean enable) {
        synchronized (this.mCallbackLock) {
            Iterator it = this.mCallbacks.iterator();
            while (it.hasNext()) {
