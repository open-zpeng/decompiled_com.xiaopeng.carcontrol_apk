...
public class AvasController extends BaseCarController<CarAvasManager, IAvasController.Callback> implements IAvasController {
    ...
    */
    ...
    @Override // com.xiaopeng.carcontrol.carmanager.controller.IAvasController
    public void setLockAvasNewSw(boolean enable) {
        if (this.mCarConfig.isSupportLockUnLockRspSep()) {
            try {
                this.mCarManager.setLockUnlockSoundSwitchStatus(enable ? 1 : 0);
            } catch (Exception e) {
                LogUtils.e(TAG, "setLockAvasNewSw: " + e.getMessage(), false);
            }
        }
    }

    @Override // com.xiaopeng.carcontrol.carmanager.controller.IAvasController
    public void setUnLockAvasNewSw(boolean enable) {
        if (this.mCarConfig.isSupportLockUnLockRspSep()) {
            try {
                this.mCarManager.setUnlockSoundSwitchStatus(enable ? 1 : 0);
            } catch (Exception e) {
                LogUtils.e(TAG, "setUnLockAvasNewSw: " + e.getMessage(), false);
            }
        }
    }
