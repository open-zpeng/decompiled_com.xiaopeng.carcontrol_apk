...
public class AmbientManagerNew extends AbstractAmbientManager {
    ...
    private boolean supportNewService;
    ...
    public AmbientManagerNew(XUIManager xuiManager) {
        ...
        try {
            this.supportNewService = showAmbientLightModes().contains("stable");
            LogUtils.i(TAG, "supportNewService" + this.supportNewService);
        } catch (Exception e2) {
    ...
    public Set<String> showAmbientLightModes() throws XUIServiceNotConnectedException {
        Set<String> showAmbientLightModes = this.mManager.showAmbientLightModes();
        LogUtils.i(TAG, "showAmbientLightModes:result:" + showAmbientLightModes, false);
        return showAmbientLightModes;
    }
    ...
    @Override // com.xiaopeng.carcontrol.carmanager.ambient.AbstractAmbientManager
    public boolean isSupportNewService() {
        return this.supportNewService;
    }
