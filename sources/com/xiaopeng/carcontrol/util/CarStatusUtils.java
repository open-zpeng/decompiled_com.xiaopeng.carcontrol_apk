...
public class CarStatusUtils {
    ...
    private static Boolean mIsD55A;
    ...
    public static String getHardwareCarType() {
        Exception e;
        String hardwareCarType;
        try {
            hardwareCarType = Car.getHardwareCarType();
        } catch (Exception e2) {
            e = e2;
        }
        try {
    ...
    public static String getNewHardwareCarType() {
        ...
        switch (c) {
            ...
            case 6:
                return "F30";
            default:
                return BuildConfig.LIB_PRODUCT;
        }
    }
    ...
    public static boolean isD55ACarType() {
        if (mIsD55A == null) {
            mIsD55A = Boolean.valueOf("Q3A".equals(getHardwareCarType()));
        }
        return mIsD55A.booleanValue();
    }
