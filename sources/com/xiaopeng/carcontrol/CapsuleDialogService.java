    ...
    private void showPassiveExitDialogTips(boolean isVipSeat, boolean subMode, boolean isSleepMode) {
        ...
        if (subMode) {
            if (this.mPassiveExitDialog == null) {
                ...
                xDialog2.setTitle(i);
                int i2 = BaseFeatureOption.getInstance().isSupportAutoSeat() ? R.string.space_capsule_sleep_exit_passive_tts : R.string.space_capsule_sleep_exit_passive_tts_recover;
                XDialog xDialog3 = this.mPassiveExitDialog;
                if (!isSleepMode) {
                    i2 = R.string.space_capsule_cinema_exit_passive_tts;
                }
                xDialog3.setMessage(i2);
