...
public abstract class BaseFeatureOption {
    ...
    public boolean isSupportAutoSeat() {
        return true;
    }
    ...
    public boolean isSupportCarImgWithCarType() {
        return false;
    }
    ...
    public boolean isSupportSpaceCapsuleGuideSetting() {
        return true;
    }
    ...
    public boolean isSupportUnLockRspDataTransfer() {
        return false;
    }
