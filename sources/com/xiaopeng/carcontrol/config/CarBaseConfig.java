...
public abstract class CarBaseConfig {
    ...
    public static final String PROPERTY_PM25_DISPLAY = "persist.sys.xiaopeng.pm25_display";
    ...
    public boolean isSupportLockUnLockRspSep() {
        return false;
    }
    ...
    public boolean isSupportInnerPm25Show() {
        return isSupportInnerPm25();
    }
    ...
    public boolean isSupportSHC() {
        return XpCarFeatures.hasSHCFeature() == 1;
    }
}
