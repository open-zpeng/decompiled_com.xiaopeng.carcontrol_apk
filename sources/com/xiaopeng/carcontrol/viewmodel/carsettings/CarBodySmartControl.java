...
public class CarBodySmartControl {
    ...
    public void setLockResponseNew(int lockResponse) {
        ICarBodyViewModel iCarBodyViewModel = this.mCarBodyVm;
        if (iCarBodyViewModel != null) {
            iCarBodyViewModel.setLockResponseNew(lockResponse);
        }
    }

    public void setUnLockResponseNew(int unlockResponse) {
        ICarBodyViewModel iCarBodyViewModel = this.mCarBodyVm;
        if (iCarBodyViewModel != null) {
            iCarBodyViewModel.setUnLockResponseNew(unlockResponse);
        }
    }
