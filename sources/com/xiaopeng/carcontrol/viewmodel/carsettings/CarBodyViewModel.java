...
public class CarBodyViewModel extends CarBodyBaseViewModel {
    ...
    private final MutableLiveData<UnlockResponse> mLockResponseNew = new MutableLiveData<>();
    private final MutableLiveData<UnlockResponse> mUnLockResponseNew = new MutableLiveData<>();
    ...
    public void setLockResponseNewMode(UnlockResponse type) {
        if (type != null) {
            setLockResponseNew(type.toBcmCmd());
        }
    }

    public void setUnLockResponseNewMode(UnlockResponse type) {
        if (type != null) {
            setUnLockResponseNew(type.toBcmCmd());
        }
    }
    ...
    public UnlockResponse getLockResponseNewMode() {
        return UnlockResponse.fromBcmState(getLockResponseNew());
    }

    public UnlockResponse getUnLockResponseNewMode() {
        return UnlockResponse.fromBcmState(getUnLockResponseNew());
    }
    ...
    public LiveData<UnlockResponse> getLockResponseNewData() {
        return this.mLockResponseNew;
    }

    public LiveData<UnlockResponse> getUnLockResponseNewData() {
        return this.mUnLockResponseNew;
    }
    ...
    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.CarBodyBaseViewModel
    protected void handleLockTypeNewChanged(int type) {
        this.mLockResponseNew.postValue(UnlockResponse.fromBcmState(type));
    }

    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.CarBodyBaseViewModel
    protected void handleUnLockTypeNewChanged(int type) {
        this.mUnLockResponseNew.postValue(UnlockResponse.fromBcmState(type));
    }
