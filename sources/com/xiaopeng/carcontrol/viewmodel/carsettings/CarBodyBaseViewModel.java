...
public abstract class CarBodyBaseViewModel implements ICarBodyViewModel {
    ...
    protected abstract void handleLockTypeNewChanged(int type);
    ...
    protected abstract void handleUnLockTypeNewChanged(int type);
    ...
    public class AnonymousClass1 implements IBcmController.Callback {
        ...
        @Override // com.xiaopeng.carcontrol.carmanager.controller.IBcmController.Callback
        public void onLockResponseNewChanged(int type) {
            CarBodyBaseViewModel.this.handleLockTypeNewChanged(type);
        }

        @Override // com.xiaopeng.carcontrol.carmanager.controller.IBcmController.Callback
        public void onUnLockResponseNewChanged(int type) {
            CarBodyBaseViewModel.this.handleUnLockTypeNewChanged(type);
        }
    ...
    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.ICarBodyViewModel
    public void setUnlockResponseForAvas(boolean enable) {
        if (CarBaseConfig.getInstance().isNewAvasArch()) {
    ...
    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.ICarBodyViewModel
    public void setLockResponseNew(int type) {
        this.mBcmController.setLockResponseNew(type);
        setLockResponseNowForAvas(type == 2);
    }

    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.ICarBodyViewModel
    public int getLockResponseNew() {
        return this.mBcmController.getLockResponseNewSp();
    }

    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.ICarBodyViewModel
    public void setLockResponseNowForAvas(boolean enable) {
        this.mAvasController.setLockAvasNewSw(enable);
    }

    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.ICarBodyViewModel
    public void setUnLockResponseNew(int type) {
        this.mBcmController.setUnLockResponseNew(type);
        setUnLockResponseNowForAvas(type == 2);
    }

    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.ICarBodyViewModel
    public int getUnLockResponseNew() {
        return this.mBcmController.getUnLockResponseNewSp();
    }

    @Override // com.xiaopeng.carcontrol.viewmodel.carsettings.ICarBodyViewModel
    public void setUnLockResponseNowForAvas(boolean enable) {
        this.mAvasController.setUnLockAvasNewSw(enable);
    }
