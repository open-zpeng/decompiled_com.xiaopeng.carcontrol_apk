...
public class ServiceViewModel implements IServiceViewModel, DataSyncModel.DataSyncChangeListener {
    ...
    public ServiceViewModel() {
        ...
        this.mDelayShowPGearMenuTask = new Runnable() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$8xjmS9I0WpaPdbkBuayarg573YE
            @Override // java.lang.Runnable
            public final void run() {
                ServiceViewModel.lambda$new$17();
            }
        };
        this.mCheckTelescopeTask = new Runnable() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$Vqg95vm8SiGk4b9Wqh4Bk8QS65E
            @Override // java.lang.Runnable
            public final void run() {
                ServiceViewModel.this.lambda$new$18$ServiceViewModel();
            }
        };
    ...
    public void resumeSaveSettings() {
        ...
        if (this.mCarConfigHelper.isSupportSaberLightMode()) {
            if (this.mDataSync.mIsDataSynced) {
            ...
            LogUtils.d(TAG, "Saber Light not support, force set Park lamp B to false ");
        ...
        if (this.mDataSync.mIsDataSynced) {
            ...
            if (this.mCarConfigHelper.isSupportLockUnLockRspSep()) {
                if (BaseFeatureOption.getInstance().isSupportUnLockRspDataTransfer() && !this.mFunctionModel.getUnlockRspTransferSw()) {
                    this.mFunctionModel.setUnlockRspTransferSw(true);
                    int unlockResponse = this.mDataSync.getUnlockResponse();
                    CarBodySmartControl.getInstance().setLockResponseNew(unlockResponse);
                    CarBodySmartControl.getInstance().setUnLockResponseNew(unlockResponse);
                } else {
                    int lockResponseNew = this.mDataSync.getLockResponseNew();
                    LogUtils.i(TAG, "resume Lock ResponseNew value: " + lockResponseNew, false);
                    CarBodySmartControl.getInstance().setLockResponseNew(lockResponseNew);
                    int unLockResponseNew = this.mDataSync.getUnLockResponseNew();
                    LogUtils.i(TAG, "resume UnLock ResponseNew value: " + unLockResponseNew, false);
                    CarBodySmartControl.getInstance().setUnLockResponseNew(unLockResponseNew);
                }
            } else {
                int unlockResponse2 = this.mDataSync.getUnlockResponse();
                LogUtils.i(TAG, "resume Unlock Response value: " + unlockResponse2, false);
    ...
    */
    ...
    protected void syncLockData(CarControlSyncDataEvent event) {
        ...
        if (BaseFeatureOption.getInstance().isSupportUnlockResponseSettings()) {
            if (this.mCarConfigHelper.isSupportLockUnLockRspSep()) {
                if (BaseFeatureOption.getInstance().isSupportUnLockRspDataTransfer() && !this.mFunctionModel.getUnlockRspTransferSw()) {
                    this.mFunctionModel.setUnlockRspTransferSw(true);
                    int unlockResponseSp = this.mBcmController.getUnlockResponseSp();
                    if (!event.isUnlockResponse()) {
                        LogUtils.i(TAG, "Unlock response, save currentValue: " + unlockResponseSp, false);
                        CarBodySmartControl.getInstance().setLockResponseNew(unlockResponseSp);
                        CarBodySmartControl.getInstance().setUnLockResponseNew(unlockResponseSp);
                    } else {
                        int unlockResponse = this.mDataSync.getUnlockResponse();
                        LogUtils.i(TAG, "Unlock response, resume saved value: " + unlockResponse + ", currentValue: " + unlockResponseSp, false);
                        CarBodySmartControl.getInstance().setLockResponseNew(unlockResponse);
                        CarBodySmartControl.getInstance().setUnLockResponseNew(unlockResponse);
                    }
                } else {
                    int lockResponseNewSp = this.mBcmController.getLockResponseNewSp();
                    if (!event.isLockResponseNew()) {
                        LogUtils.i(TAG, "Lock response New, save currentValue: " + lockResponseNewSp, false);
                        CarBodySmartControl.getInstance().setLockResponseNew(lockResponseNewSp);
                    } else {
                        int unlockResponse2 = this.mDataSync.getUnlockResponse();
                        LogUtils.i(TAG, "Lock response New, resume saved value: " + unlockResponse2 + ", currentValue: " + lockResponseNewSp, false);
                        CarBodySmartControl.getInstance().setLockResponseNew(unlockResponse2);
                    }
                    int unLockResponseNewSp = this.mBcmController.getUnLockResponseNewSp();
                    if (!event.isUnLockResponseNew()) {
                        LogUtils.i(TAG, "UnLock response New, save currentValue: " + unLockResponseNewSp, false);
                        CarBodySmartControl.getInstance().setUnLockResponseNew(unLockResponseNewSp);
                    } else {
                        int unlockResponse3 = this.mDataSync.getUnlockResponse();
                        LogUtils.i(TAG, "UnLock response New, resume saved value: " + unlockResponse3 + ", currentValue: " + unLockResponseNewSp, false);
                        CarBodySmartControl.getInstance().setUnLockResponseNew(unlockResponse3);
                    }
                }
            } else {
                int unlockResponseSp2 = this.mBcmController.getUnlockResponseSp();
                if (!event.isUnlockResponse()) {
                    LogUtils.i(TAG, "Unlock response, save currentValue: " + unlockResponseSp2, false);
                    CarBodySmartControl.getInstance().setUnlockResponse(unlockResponseSp2);
                } else {
                    int unlockResponse4 = this.mDataSync.getUnlockResponse();
                    LogUtils.i(TAG, "Unlock response, resume saved value: " + unlockResponse4 + ", currentValue: " + unlockResponseSp2, false);
                    CarBodySmartControl.getInstance().setUnlockResponse(unlockResponse4);
                }
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: syncXPilotData */
    public void lambda$handleSyncSettings$11$ServiceViewModel(CarControlSyncDataEvent event) {
    ...
    void handleSyncSettings(final CarControlSyncDataEvent event) {
        ...
        syncAvasData(event);
        if (this.mVcuController.getGearLevel() == 4) {
            ThreadUtils.postDelayed(new Runnable() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$W2dNT3fCgNnhvKraPvHb82PwvPU
                @Override // java.lang.Runnable
                public final void run() {
                    ServiceViewModel.this.lambda$handleSyncSettings$11$ServiceViewModel(event);
                }
            }, 2000L);
        }
    ...
    public void showReadyDisableDialog() {
        ...
        ThreadUtils.runOnMainThread(new Runnable() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$0npHt66oUxspIxJNhgO6qa49Eyw
            @Override // java.lang.Runnable
            public final void run() {
                ServiceViewModel.this.lambda$showReadyDisableDialog$13$ServiceViewModel();
            }
        });
    }

    public /* synthetic */ void lambda$showReadyDisableDialog$13$ServiceViewModel() {
        int i;
        int i2;
        ...
        if (this.mReadyDisableDialog == null) {
            ...
            this.mReadyDisableDialog.setPositiveButton(ResUtils.getString(R.string.btn_ok), new XDialogInterface.OnClickListener() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$h6deOXYdBzCLFaSzzaO2ycCtEeI
                @Override // com.xiaopeng.xui.app.XDialogInterface.OnClickListener
                public final void onClick(XDialog xDialog, int i8) {
                    ServiceViewModel.this.lambda$null$12$ServiceViewModel(xDialog, i8);
                }
            });
    ...
    public /* synthetic */ void lambda$null$12$ServiceViewModel(XDialog xDialog, int i) {
        dismissReadyDisableDialog();
    }
    ...
    public void dismissReadyDisableDialog(boolean dismissFromNapa) {
        ...
        ThreadUtils.runOnMainThread(new Runnable() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$zgNnWtvJ2oI1r7f4O-qQMoiyNFw
            @Override // java.lang.Runnable
            public final void run() {
                ServiceViewModel.this.lambda$dismissReadyDisableDialog$14$ServiceViewModel();
            }
        });
        this.mHasCheckReadyDisableTask = false;
        this.mCheckBrkPedalStartTime = 0L;
    ...
    public /* synthetic */ void lambda$dismissReadyDisableDialog$14$ServiceViewModel() {
    ...
    public void showEpbDialog() {
        ...
        ThreadUtils.runOnMainThread(new Runnable() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$xWwNfGZrqQx8L-efVHKUc_gGJ_M
            @Override // java.lang.Runnable
            public final void run() {
                ServiceViewModel.this.lambda$showEpbDialog$16$ServiceViewModel();
            }
        });
    }

    public /* synthetic */ void lambda$showEpbDialog$16$ServiceViewModel() {
        ...
        xDialog.getDialog().setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$eYUVKOGe1wIeiGof02uEdRR0Yuw
            @Override // android.content.DialogInterface.OnDismissListener
            public final void onDismiss(DialogInterface dialogInterface) {
                ServiceViewModel.this.lambda$null$15$ServiceViewModel(dialogInterface);
            }
        });
        xDialog.show();
    ...
    public /* synthetic */ void lambda$null$15$ServiceViewModel(DialogInterface dialog) {
        dismissEpbDialog();
    }
    ...
    public /* synthetic */ void lambda$new$18$ServiceViewModel() {
    ...
    public void handleSdcObstacleTips(int state) {
        if (state == 1) {
            ...
            ThreadUtils.runOnMainThread(new Runnable() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$NIPjGP9pClz15XuwNSkXijcIkyU
                @Override // java.lang.Runnable
                public final void run() {
                    ServiceViewModel.this.lambda$handleSdcObstacleTips$20$ServiceViewModel();
                }
            });
        }
    }
    ...
    public /* synthetic */ void lambda$handleSdcObstacleTips$20$ServiceViewModel() {
    ...
    public void handleBossKeyDown() {
        if (this.mIcmController.getDoorBossKeySw()) {
            ...
            if (!this.mIsBossKeyPressed) {
                ...
                this.mBgHandler.post(new Runnable() { // from class: com.xiaopeng.carcontrol.viewmodel.service.-$$Lambda$ServiceViewModel$DLQHcDwFdXpBJmQTGgPcJs6qkUo
                    @Override // java.lang.Runnable
                    public final void run() {
