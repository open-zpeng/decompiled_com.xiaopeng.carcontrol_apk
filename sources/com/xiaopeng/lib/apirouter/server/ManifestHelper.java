...
public class ManifestHelper {
    ...
    static {
        ...
        Pair<IBinder, String> pair3 = new Pair<>(new CarControlSpeechObserver_Stub(), CarControlSpeechObserver_Manifest.toJsonManifest());
        for (String str3 : CarControlSpeechObserver_Manifest.getKey()) {
            mapping.put(str3, pair3);
        }
        Pair<IBinder, String> pair4 = new Pair<>(new VuiUnityObserver_Stub(), VuiUnityObserver_Manifest.toJsonManifest());
        for (String str4 : VuiUnityObserver_Manifest.getKey()) {
